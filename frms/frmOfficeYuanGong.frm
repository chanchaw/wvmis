...
Begin VB.Form frmOfficeYuanGong 
   Caption         =   "员工选择"
   ClientHeight    =   5910
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   10425
      _DataPath       =   ""
      Bands           =   "frmOfficeYuanGong.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmOfficeYuanGong.frx":08D0
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmOfficeYuanGong"
...
Private Sub GetDye()
        ...
        strSQL = "SELECT B_Name FROM G_Employee"
...
Private Sub setstyle()
     TDBGrid1.Columns("B_Name").Caption = "员工姓名"
     TDBGrid1.Columns("B_Name").width = 3000
