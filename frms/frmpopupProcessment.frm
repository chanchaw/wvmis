...
Begin VB.Form frmpopupProcessment 
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   8864
      _DataPath       =   ""
      Bands           =   "frmpopupProcessment.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmpopupProcessment.frx":085A
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmpopupProcessment"
...
Private theprocessmentID As String
Private theprocessmentName As String
Private thephone As String
Private theAlias As String

Public Property Get processmentid() As String
    processmentid = theprocessmentID
End Property

Public Property Get processmentName() As String
    processmentName = theprocessmentName
End Property
...
Private Sub GetClient()
    ...
    strSQL = "Select B_SID,B_Name,B_phone From G_Employee Where B_Department='深加工跟单'"
...
Private Sub SelectClientID()
    ...
    theprocessmentID = rsClient!B_sid
    theprocessmentName = rsClient!B_name
    thephone = rsClient!B_phone
    rsClient.Close
...
Private Sub setstyle()
     ...
     TDBGrid1.Columns("B_SID").Caption = "深加工跟单编号"
     TDBGrid1.Columns("B_Name").Caption = "深加工跟单名称"
    TDBGrid1.Columns("B_phone").Caption = "联系方式"
End Sub
