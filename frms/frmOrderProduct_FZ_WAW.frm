...
Begin VB.Form frmOrderProduct_FZ_WAW 
   Caption         =   "洗标和织标位置"
   ClientHeight    =   8355
   ClientLeft      =   120
   ClientTop       =   450
   ...
   EndProperty
   Icon            =   "frmOrderProduct_FZ_WAW.frx":0000
   LinkTopic       =   "Form2"
   ScaleHeight     =   8355
   ScaleWidth      =   12135
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   14843
      _DataPath       =   ""
      Bands           =   "frmOrderProduct_FZ_WAW.frx":058A
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmOrderProduct_FZ_WAW.frx":0752
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmOrderProduct_FZ_WAW"
...
Private Sub saveImage()
    ...
    Dim rs As New RecordSet
    Dim sql As String
    sql = "SELECT * FROM WVAccountImage.dbo.G_image_NEW_WAW where 1=0"
    rs.Open sql, Gm.cnnToolImage.cnn, adOpenKeyset, adLockPessimistic
     ...
     Else
        ...
        Dim sql1 As String
        sql1 = "SELECT * FROM WVAccountImage.dbo.G_image_NEW_WAW where B_OrderID='" & m_OrderID & "'"
...
Dim sql As String
    If m_ID > 0 Then
        sql = "delete from WVAccountImage.dbo.G_image_NEW_WAW where B_OrderID='" & m_OrderID & "'"
...
Private Sub OpenImage()
            ...
            sql = "SELECT * FROM WVAccountImage.dbo.G_image_NEW_WAW where B_OrderID='" & m_OrderID & "'"
