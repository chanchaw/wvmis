...
Begin VB.Form frmOriginalLastYearReport 
   Caption         =   "上年度报表"
   ClientHeight    =   7560
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   12012
      _DataPath       =   ""
      Bands           =   "frmOriginalLastYearReport.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmOriginalLastYearReport.frx":0E50
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmOriginalLastYearReport"
...
Private Sub grid()
    ...
    sql = "exec usp_OriginalLastYearReport '" & a & "','" & b & "'"
...
Private Sub setgrid()
    ...
    TDBGrid1.Columns("B_LotNumber").Caption = "仓位"
