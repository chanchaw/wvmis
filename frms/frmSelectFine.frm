...
Private Sub SetGrid()
    ...
    TDBGrid1.Columns("B_boxqty").Caption = "码数"
    TDBGrid1.Columns("B_ps").Caption = "已入匹数"
    TDBGrid1.Columns("B_gj").Caption = "已入公斤"
    TDBGrid1.Columns("B_ms").Caption = "已入米数"
    TDBGrid1.Columns("B_ma").Caption = "已入码数"
