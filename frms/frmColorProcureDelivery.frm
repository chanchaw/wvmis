...
Begin VB.Form frmColorProcureDelivery 
   Caption         =   "色布采购发货"
   ClientHeight    =   7230
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   12753
      _DataPath       =   ""
      Bands           =   "frmColorProcureDelivery.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmColorProcureDelivery.frx":53FA
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmColorProcureDelivery"
    ...
    For i = 0 To TDBGrid1.Columns.Count - 1
        If TDBGrid1.Columns(i).width > 0 Then
            If TDBGrid1.Columns(i).Visible = True Then
                ...
                strSQL = "update G_BLSField set B_GridWidth='" & dWidth & "' where B_ObjectID='11S063' and B_FieldName='" & szFieldName & "'"
...
Private Sub TDBGridAddOneRow(ByVal vItemID As Long)
   ...
   rsdetail.AddNew
    ...
    rsdetail!B_DepartColor = IIf(IsNull(rs!B_DepartColor), "", rs!B_DepartColor)      'rs!B_DepartColor
    rsdetail.Update
End Sub
...
Private Sub save()
    ...
    sql1 = sql1 & "'12B008','COL21 ','" & Gm.SysID.SystemUser & "','" & FlatEdit2.Text & "'"
...
Private Sub MoveFirst()
    ...
    sql = sql & " left outer join G_Employee c on a.B_Hand=c.B_SID where B_ObjectID='12B008' and  B_BillType='COL21'"
...
Private Sub MovePrevious()
    ...
    sql = sql & " from G_Billcolor a left outer join G_ContactCompany b on a.B_Shipment=b.B_ClientID"
    sql = sql & " left outer join G_Employee c on a.B_Hand=c.B_SID where B_ObjectID='12B008' and  B_BillType='COL21' and B_ID<'" & id & "'"
