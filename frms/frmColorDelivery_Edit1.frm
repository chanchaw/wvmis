...
Begin VB.Form frmColorDelivery_Edit1 
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   12912
      _DataPath       =   ""
      Bands           =   "frmColorDelivery_Edit1.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmColorDelivery_Edit1.frx":182A
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmColorDelivery_Edit1"
...
Public B_ClientName As String
Public sum1 As String
Public Sum2 As String
Public B_Clientid As String
Public B_DTRK As String
Public B_ZCDate As String
...
Private Sub Grid()
    ...
    sql = "exec usp_Colordelivery_edit "
    Debug.Print sql
...
'    TDBGrid1.Columns("B_GoodsNameAlias").Caption = "色布品名"
...
'    TDBGrid1.Columns("B_Name").Caption = "颜色名称"
...
Private Sub choose()
    ...
    B_ItemIDB = rss!B_ItemIDB
    B_GoodsNameAlias = rss!B_GoodsNameAlias
    B_SeHao = rss!B_SeHao
    B_Producer = rss!B_Producer
    B_Width = rss!B_Width
    B_weight = rss!B_weight
    B_PactCode = rss!B_PactCode
    B_ClientName = rss!B_ClientName
      sum1 = rss!sum1
    Sum2 = rss!Sum2
      B_Clientid = rss!B_Clientid
'    B_DTRK = rss!B_DTRK
    B_ZCDate = rss!B_ZCDate
    
    B_hex = IIf(IsNull(rss!B_hex), "", rss!B_hex)
    B_name = rss!B_name
    B_sid = rss!B_sid
    B_ItemID = rss!B_ItemID
    bsaved = True
    Me.Hide
End Sub
    ...
    For i = 0 To TDBGrid1.Columns.Count - 1
        If TDBGrid1.Columns(i).width > 0 Then
            If TDBGrid1.Columns(i).Visible = True Then
                ...
                strSQL = "update G_BLSField set B_GridWidth='" & dWidth & "' where B_ObjectID='11S027' and B_FieldName='" & szFieldName & "'"
...
'设置空加值并打印细码单
Private Sub Pri()
Dim frm1 As New frmColorJRKprintDetail_NEW

frm1.m_ZCDate = rss!B_ZCDate
frm1.m_DingDanHao = rss!B_ItemIDB
frm1.m_Color = rss!B_name
frm1.m_ItemID = rss!B_ItemID
frm1.m_JRKID = rss!B_id
 frm1.Show vbModal
Unload frm1
