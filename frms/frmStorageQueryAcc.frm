...
'下面是相关的常量
Private Const A_Storage As String = "辅料仓库"
Private Const strSQLInv As String = "exec dbo.[usp_InvAccessory] '',''" '库存存储过程
Private Const strSQLInvSpend As String = "" '领料库存
Private Const A_BLObjectID As String = "12B002" '根据该单据对象的设置，将非数量的字段锁定为不可修改
Private Const A_BLObjectIDCreated As String = "12B002"   '被生成的单据对象编号
Private Const A_GridStyleObjectID As String = "13B003"  '设置网格显示用到的对象
