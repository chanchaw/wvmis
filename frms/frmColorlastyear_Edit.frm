...
Begin VB.Form frmColorlastyear_Edit 
   Caption         =   "色布上年度新增"
   ClientHeight    =   6855
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   12091
      _DataPath       =   ""
      Bands           =   "frmColorlastyear_Edit.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmColorlastyear_Edit.frx":085A
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmColorlastyear_Edit"
...
Private Sub Grid()
    ...
    sql = "exec usp_selectColorlastyear "
...
'    TDBGrid1.Columns("B_ClientName").Caption = "供应商"
    TDBGrid1.Columns("B_Name").Caption = "色布名称"
...
'    supplierid = rss!B_Clientid
'    supperliername = rss!B_ClientName
