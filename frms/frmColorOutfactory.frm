...
Begin VB.Form frmColorOutfactory 
   Caption         =   "色布发家纺厂"
   ClientHeight    =   7620
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   13441
      _DataPath       =   ""
      Bands           =   "frmColorOutfactory.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmColorOutfactory.frx":5258
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmColorOutfactory"
    ...
    For i = 0 To TDBGrid1.Columns.Count - 1
        If TDBGrid1.Columns(i).width > 0 Then
            If TDBGrid1.Columns(i).Visible = True Then
                ...
                strSQL = "update G_BLSField set B_GridWidth='" & dWidth & "' where B_ObjectID='11S060' and B_FieldName='" & szFieldName & "'"
...
'    rsDetail!B_departid = rs!B_depart
    ...
    rsdetail!B_DepartColor = rs!B_DepartColor
    rsdetail.Update
End Sub
...
Private Sub save()
    ...
    Do While Not rsdetail.EOF
        ...
        If rsdetail!B_process = "" Then
            MsgBox "第" & i & "行家纺厂不能为空", vbInformation, "提示"
            Exit Sub
        End If
    ...
    sql1 = sql1 & "'12B008','COL18 ','" & Gm.SysID.SystemUser & "','" & FlatEdit2.Text & "'"
...
'        End If
        ...
        If rs3.RecordCount > 0 Then
            ...
            sql2 = sql2 & ",'" & rsdetail!B_colorname & "','" & rsdetail!B_specification & "','" & rsdetail!B_colorid & "','" & rsdetail!B_SeHao & "'"
            sql2 = sql2 & ",'" & rsdetail!B_PIShu & "','" & rsdetail!B_weight & "','" & rsdetail!B_meter & "','" & rsdetail!B_Ma & "'"
            sql2 = sql2 & ",'" & rsdetail!B_Clientid & "','" & rsdetail!B_DeliveryNote & "','" & rsdetail!B_type & "','" & rsdetail!B_Waitfreight & "','" & rsdetail!B_processid & "','" & rsdetail!B_memo & "','" & "" & "','" & rsdetail!B_repaircost & "','','" & rsdetail!B_Freight & "','" & rsdetail!B_Prepaidfreight & "','" & rsdetail!B_color & "','" & rsdetail!B_DepartColor & "'"
            Gm.cnnTool.cnn.Execute sql2
        Else
            saveadddetail
        End If
...
Private Sub MoveFirst()
    ...
    sql = sql & " left outer join G_Employee c on a.B_Hand=c.B_SID where B_ObjectID='12B008' and  B_BillType='COL18'"
...
Private Sub MovePrevious()
    ...
    sql = sql & " from G_Billcolor a left outer join G_ContactCompany b on a.B_Shipment=b.B_ClientID"
    sql = sql & " left outer join G_Employee c on a.B_Hand=c.B_SID where B_ObjectID='12B008' and  B_BillType='COL18' and B_ID<'" & id & "'"
...
'            rsDetail!B_depart = IIf(IsNull(rs!B_ClientName), "", rs!B_ClientName)
            rsdetail!B_colorname = IIf(IsNull(rs!B_GoodsNameAlias), "", rs!B_GoodsNameAlias)
            rsdetail!B_specification = IIf(IsNull(rs!B_specification), "", rs!B_specification)
...
'            rsDetail!B_departid = rs!B_depart
            ...
            rsdetail!B_ItemID = IIf(IsNull(rs!B_ItemID), "", rs!B_ItemID)
