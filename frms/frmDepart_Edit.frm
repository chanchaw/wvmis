...
Begin VB.Form frmpopupDepart 
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmDepart_Edit.frx":0BE4
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmpopupDepart"
...
Private thedepartID As String
Private thedepartName As String
Private theAlias As String

Public Property Get departid() As String
    departid = thedepartID
End Property

Public Property Get departName() As String
    departName = thedepartName
End Property
...
Private Sub GetClient()
    ...
    strSQL = "Select B_ClientID,B_ClientName From G_ContactCompany Where B_ContactType='染厂'"
...
Private Sub SelectClientID()
    ...
    thedepartID = rsClient!B_Clientid
    thedepartName = rsClient!B_ClientName
...
Private Sub setstyle()
     ...
     TDBGrid1.Columns("B_ClientID").Caption = "染厂编号"
     TDBGrid1.Columns("B_ClientName").Caption = "染厂名称"
