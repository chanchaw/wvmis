...
Begin VB.Form frmOriginalReturn 
   Caption         =   "采购退货"
   ClientHeight    =   7455
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   13150
      _DataPath       =   ""
      Bands           =   "frmOriginalReturn.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmOriginalReturn.frx":51E4
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmOriginalReturn"
    ...
    For i = 0 To TDBGrid1.Columns.Count - 1
        If TDBGrid1.Columns(i).width > 0 Then
            If TDBGrid1.Columns(i).Visible = True Then
                ...
                strSQL = "update G_BLSField set B_GridWidth='" & dWidth & "' where B_ObjectID='11S031' and B_FieldName='" & szFieldName & "'"
...
Private Sub save()
    ...
    Do While Not rsdetail.EOF
        ...
        If rsdetail!B_price <= 0 Or rsdetail!B_price = "" Then
            MsgBox "第" & i & "行价格不能为0或者为空", vbInformation, "提示"
            Exit Sub
        End If
    ...
    sql1 = sql1 & "'12B004','YARN03','" & Gm.SysID.SystemUser & "','" & FlatEdit2.Text & "'"
...
Private Sub savedetail()
    ...
    Do While Not rsdetail.EOF
        ...
        sql2 = "exec usp_OriginalreturnDetail '" & item & "','" & id & "','" & rsdetail!B_ItemIDB & "','" & rsdetail!B_suppliersid & "'"
        sql2 = sql2 & ",'" & rsdetail!B_colorid & "','" & rsdetail!B_specification & "','" & rsdetail!B_qty & "','" & rsdetail!B_price & "'"
        sql2 = sql2 & ",'" & rsdetail!B_Sum & "','" & rsdetail!B_Cang & "','" & rsdetail!B_memo & "','" & "" & "','" & rsdetail!B_BoxQty & "','" & rsdetail!B_DeliveryNote & "'"
...
Private Sub savetoupdate1()
    ...
    Do While Not rsdetail.EOF
        ...
        If rs3.RecordCount > 0 Then
            sql2 = "exec usp_Originalreturndetail_update '" & rsdetail!B_ItemID & "','" & id & "','" & rsdetail!B_ItemIDB & "','" & rsdetail!B_suppliersid & "'"
            sql2 = sql2 & ",'" & rsdetail!B_colorid & "','" & rsdetail!B_specification & "','" & rsdetail!B_qty & "','" & rsdetail!B_price & "'"
            sql2 = sql2 & ",'" & rsdetail!B_Sum & "','" & rsdetail!B_Cang & "','" & rsdetail!B_memo & "','" & "" & "','" & rsdetail!B_BoxQty & "','" & rsdetail!B_DeliveryNote & "'"
...
Private Sub MoveFirst()
    ...
    sql = sql & " where B_ObjectID='12B004' and  B_BillType='YARN03'"
...
Private Sub MovePrevious()
    ...
    End If
     sql = "select top 1 B_id,B_CodeID,B_Date,B_Freightnum,B_HandNum,B_CarNum,B_payment,B_Shipment,b.B_ClientName,B_HandMent,c.B_Name,B_cope,B_drivename "
    sql = sql & " from G_BillYarn a left outer join G_ContactCompany b on a.B_Shipment=b.B_ClientID left outer join G_Employee c on a.B_HandMent=c.B_SID"
    sql = sql & " where B_ObjectID='12B004' and  B_BillType='YARN03' and B_ID<'" & id & "'"
...
Public Sub openbill()
   Dim sql As String
   Dim rs As New RecordSet
   sql = "select B_ItemID,B_ID,B_OrderCode,B_Supplier,b.B_ClientName,B_GoodsID,c.B_Name,a.B_Specification,B_Qty,a.B_Price,B_Sum,B_LotNumber,B_MemoDetail,B_boxqty,B_DeliveryNote"
   ...
   Do While Not rs.EOF
       ...
       rsdetail!B_ItemID = rs!B_ItemID
         ...
         rsdetail!B_suppliers = rs!B_ClientName
