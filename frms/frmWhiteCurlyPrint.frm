...
Begin VB.Form frmWhiteCurlyPrint 
   Caption         =   "白坯打卷记录查询"
   ClientHeight    =   7425
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   13097
      _DataPath       =   ""
      Bands           =   "frmWhiteCurlyPrint.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmWhiteCurlyPrint.frx":1320
         AccessibleName  =   ""
         ...
         Begin VB.PictureBox Picture1 
            ...
            Begin TDBTime6Ctl.TDBTime TDBTime1 
               ...
               _ExtentX        =   2355
               _ExtentY        =   661
               Caption         =   "frmWhiteCurlyPrint.frx":13A2
               BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                  Name            =   "Tahoma"
                  Size            =   8.25
                  Charset         =   0
                  ...
                  Strikethrough   =   0   'False
               EndProperty
               Keys            =   "frmWhiteCurlyPrint.frx":1407
               Spin            =   "frmWhiteCurlyPrint.frx":1457
               AlignHorizontal =   0
               AlignVertical   =   0
               Appearance      =   1
            ...
            Begin TDBTime6Ctl.TDBTime TDBTime2 
               ...
               _ExtentX        =   2355
               _ExtentY        =   661
               Caption         =   "frmWhiteCurlyPrint.frx":147F
               BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                  Name            =   "Tahoma"
                  Size            =   8.25
                  Charset         =   0
                  ...
                  Strikethrough   =   0   'False
               EndProperty
               Keys            =   "frmWhiteCurlyPrint.frx":14E4
               Spin            =   "frmWhiteCurlyPrint.frx":1534
               AlignHorizontal =   0
               AlignVertical   =   0
               Appearance      =   1
               BackColor       =   -2147483643
   ...
   End
End
Attribute VB_Name = "frmWhiteCurlyPrint"
...
Private Sub grid()
    ...
    a = DTPicker1.Value & TDBTime1.Value
    b = b & TDBTime2.Value
    
    sql = "exec usp_WhiteCurlyPrint '" & a & "','" & b & "','" & theClientID & "','" & FlatEdit2.Text & "','" & FlatEdit3.Text & "','" & FlatEdit4.Text & "'"
    Debug.Print sql
...
'    TDBGrid1.Columns("datemin").Caption = "打卷开始时间"
'    TDBGrid1.Columns("datemax").Caption = "打卷终止时间"
'
'    TDBGrid1.Columns("rowindex").width = 900
'    TDBGrid1.Columns("B_Width").width = 1500
'    TDBGrid1.Columns("B_UnitWeight").width = 1500
'    TDBGrid1.Columns("sum1").width = 900
'    TDBGrid1.Columns("sum2").width = 900
'    TDBGrid1.Columns("B_Machine").width = 900
'    TDBGrid1.Columns("B_PactCode").width = 1200
'    TDBGrid1.Columns("B_ItemIDB").width = 1200
    
    TDBGrid1.Columns("sum2").NumberFormat = "0.0"
    
    TDBGrid1.Columns("B_BCitemid").Visible = False
    TDBGrid1.Columns("B_BCitemid").AllowSizing = False
    TDBGrid1.Columns("B_BCitemid").Locked = True
    ...
    For i = 0 To TDBGrid1.Columns.Count - 1
        If TDBGrid1.Columns(i).width > 0 Then
            If TDBGrid1.Columns(i).Visible = True Then
                ...
                strSQL = "update G_BLSField set B_GridWidth='" & dWidth & "' where B_ObjectID='11S053' and B_FieldName='" & szFieldName & "'"
