...
Begin VB.Form frmColorInsetDetail 
   Caption         =   "染厂色布入库明细表"
   ClientHeight    =   7500
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   13229
      _DataPath       =   ""
      Bands           =   "frmColorInsetDetail.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmColorInsetDetail.frx":1D74
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmColorInsetDetail"
...
Private Sub grid()
    ...
    sql = "exec usp_SelectColorInsetDetail '" & a & "','" & b & "','" & Originalsuppliers & "','" & ComboBox1.Text & "','" & FlatEdit3.Text & "'"
    Debug.Print sql
...
'    TDBGrid1.Columns("B_meter").width = 900
    TDBGrid1.Columns("B_BoxQty").width = 900
...
Private Sub TDBGrid1_DblClick()
    ...
    sql = "exec usp_colororderselect '" & rss!B_id & "'"
    rs.Open sql, Gm.cnnTool.cnn, adOpenKeyset, adLockPessimistic
    sql1 = "exec usp_colororderselect_Edit '" & rss!B_id & "'"
...
'    Set frm1.rsDetail = rs.Clone
    Do While Not rs1.EOF
        ...
        If IIf(IsNull(rs1!B_hex), "", rs1!B_hex) <> "" Then
            frm1.rsdetail!B_hex = rs1!B_hex
        End If
        frm1.rsdetail!B_ItemIDB = rs1!B_ItemIDB
        frm1.rsdetail!B_depart = rs1!B_ClientName
        frm1.rsdetail!B_departid = rs1!B_depart
        frm1.rsdetail!B_colorname = rs1!B_GoodsNameAlias
        frm1.rsdetail!B_specification = rs1!B_specification
        frm1.rsdetail!B_color = rs1!B_name
        frm1.rsdetail!B_colorid = rs1!B_color
        frm1.rsdetail!B_SeHao = rs1!B_SeHao
        frm1.rsdetail!B_PIShu = rs1!B_ps
        frm1.rsdetail!B_weight = rs1!B_kg
        frm1.rsdetail!B_meter = rs1!B_meter
        frm1.rsdetail!B_Ma = rs1!B_BoxQty
        frm1.rsdetail!B_ClientName = rs1!B_Client
        frm1.rsdetail!B_Clientid = rs1!B_Clientid
        frm1.rsdetail!B_DeliveryNote = rs1!B_TransfersID
        frm1.rsdetail!B_type = rs1!B_type
        frm1.rsdetail!B_memo = rs1!B_MemoDetail
        frm1.rsdetail!B_repair = IIf(IsNull(rs1!B_repair), 0, rs1!B_repair)
        frm1.rsdetail!B_repaircost = IIf(IsNull(rs1!B_repaircost), "", rs1!B_repaircost)
...
Private Sub TDBGrid1_RowColChange(LastRow As Variant, ByVal LastCol As Integer)
    ...
    sql1 = "exec usp_SelectColorInsetdetail_Edit '" & a & "'"
...
Private Sub setgrid2()
    setGridShow1
'    TDBGrid2.Columns("B_Hex").Caption = "颜色事例"
...
'    TDBGrid2.Columns("B_BoxQty").Caption = "码数"
...
Private Sub sumall()
    ...
    Do While Not rss.EOF
        ...
        c = c + IIf(IsNull(rss!B_meter), 0, rss!B_meter)
        d = d + IIf(IsNull(rss!B_BoxQty), 0, rss!B_BoxQty)
        rss.movenext
    Loop
    rss.MoveFirst
    e = Format(b, "0.0")
    ...
    TDBGrid1.Columns("B_boxqty").FooterText = "" & g & ""
End Sub
Private Sub sumall1()
    ...
    Do While Not rss1.EOF
        a = a + IIf(IsNull(rss1!B_ps), 0, rss1!B_ps)
        b = b + IIf(IsNull(Val(rss1!B_kg)), 0, Val(rss1!B_kg))
        c = c + IIf(IsNull(Val(rss1!B_meter)), 0, Val(rss1!B_meter))
        d = d + IIf(IsNull(Val(rss1!B_BoxQty)), 0, Val(rss1!B_BoxQty))
        rss1.movenext
    Loop
    rss1.MoveFirst
    e = Format(b, "0.0")
    f = Format(c, "0.0")
    g = Format(d, "0.0")
    TDBGrid2.Columns("B_Hex").FooterText = "合计"
    TDBGrid2.Columns("B_PS").FooterText = "" & a & ""
    TDBGrid2.Columns("B_kg").FooterText = "" & e & ""
        TDBGrid2.Columns("B_meter").FooterText = "" & f & ""
    TDBGrid2.Columns("B_boxqty").FooterText = "" & g & ""
End Sub
    ...
    For i = 0 To TDBGrid1.Columns.Count - 1
        If TDBGrid1.Columns(i).width > 0 Then
            If TDBGrid1.Columns(i).Visible = True Then
                ...
                strSQL = "update G_BLSField set B_GridWidth='" & dWidth & "' where B_ObjectID='11S017' and B_FieldName='" & szFieldName & "'"
    ...
    For i = 0 To TDBGrid2.Columns.Count - 1
        If TDBGrid2.Columns(i).width > 0 Then
            If TDBGrid2.Columns(i).Visible = True Then
                ...
                strSQL = "update G_BLSField set B_GridWidth='" & dWidth & "' where B_ObjectID='11S018' and B_FieldName='" & szFieldName & "'"
                Gm.cnnTool.cnn.Execute strSQL
            End If
        End If
    Next
...
Private Sub Printall()
    ...
    a = Format(DTPicker1.Value, "YYYY-MM-DD")
    b = Format(DTPicker2.Value, "YYYY-MM-DD")
    sql = "exec usp_SelectColorInsetdetail_Print '" & a & "','" & b & "','" & Originalsuppliers & "','" & ComboBox1.Text & "','" & FlatEdit3.Text & "'"
    rs.Open sql, Gm.cnnTool.cnn, adOpenKeyset, adLockPessimistic
    Debug.Print sql
    Dim frm1 As New frmModBLRPreviewOri
    Set frm1.RecordSet = rs.Clone
        
    frm1.ObjectID = "22B078"
    frm1.Show
End Sub
