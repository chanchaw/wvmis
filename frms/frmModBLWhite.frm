...
Begin VB.Form frmModBLWhite 
   ...
   Begin C1SizerLibCtl.C1Elastic C1Elastic1 
      ...
      FloodStyle      =   1
      _GridInfo       =   $"frmModBLWhite.frx":0000
      AccessibleName  =   ""
      ...
      Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
         ...
         Begin TrueOleDBGrid80.TDBGrid TDBGrid1 
            Bindings        =   "frmModBLWhite.frx":D698
            Height          =   4515
            Left            =   600
            TabIndex        =   12
            Top             =   240
   ...
   End
End
Attribute VB_Name = "frmModBLWhite"
...
Private Sub TDBGrid1_ButtonClick(ByVal ColIndex As Integer)
 If TDBGrid1.Columns("B_ItemIDB").ColIndex = ColIndex Then
    Dim frm1 As New frmPopupDingdanhao
    frm1.Show vbModal
    Dim a As String
    a = frm1.departmentid
    If a <> "" Then
        Adodc2.RecordSet("B_ItemIDB") = a
    End If
    Unload frm1
    End If
End Sub
...
Public Sub LoadObject()
    clsBL1.LoadObject
    TDBGrid1.Columns("B_ItemIDB").Button = True
End Sub
...
Private Sub LoadDropDownGrid()
    ...
    strSQL = "exec dbo.usp_GetOrderWhitePlan '" & lOrderID & "'"
    Debug.Print strSQL
...
Private Sub SetTheOthersAfterDropDownClose(ByRef vTDBDropDownCtl As TrueOleDBGrid80.TDBDropDown)
    TDBGrid1.Columns("B_SpecificationCrude").Value = vTDBDropDownCtl.Columns("B_SpecificationCrude").Value
