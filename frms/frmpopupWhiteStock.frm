...
Begin VB.Form frmpopupWhiteStock 
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   10954
      _DataPath       =   ""
      Bands           =   "frmpopupWhiteStock.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmpopupWhiteStock.frx":085A
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmpopupWhiteStock"
...
Private theOrderCode As String
Private theWidth As String
Public theUnitWeight As String
Private theProducer As String
Private theProducerName As String
Private theWhiteName As String
Private theGoodsID As String

Public theSaved As Boolean

Public Property Get OrderCode() As String
    OrderCode = theOrderCode
End Property
Public Property Get UnitWeight() As String
    UnitWeight = theUnitWeight
End Property
Public Property Get Widthid() As String
    Widthid = theWidth
End Property
...
Public Property Get ProducerName() As String
    ProducerName = theProducerName
End Property
Public Property Get WhiteName() As String
    WhiteName = theWhiteName
End Property
Public Property Get GoodsID() As String
    GoodsID = theGoodsID
End Property
...
Private Sub SelectClientID()
  If rsClient.RecordCount > 0 Then
    theOrderCode = IIf(IsNull(rsClient!B_ItemIDB), "", rsClient!B_ItemIDB)
    theWidth = IIf(IsNull(rsClient!B_Width), "", rsClient!B_Width)
    theUnitWeight = IIf(IsNull(rsClient!B_UnitWeight), "", rsClient!B_UnitWeight)
    theProducer = IIf(IsNull(rsClient!B_Producer), "", rsClient!B_Producer)
    theProducerName = IIf(IsNull(rsClient!B_ProducerName), "", rsClient!B_ProducerName)
    theWhiteName = IIf(IsNull(rsClient!B_name), "", rsClient!B_name)
    theGoodsID = IIf(IsNull(rsClient!B_GoodsID), "", rsClient!B_GoodsID)
    rsClient.Close
...
Private Sub setstyle()
     ...
     TDBGrid1.Columns("B_ItemIDB").width = 1300
     TDBGrid1.Columns("B_Name").Caption = "白坯名称"
     ...
     TDBGrid1.Columns("B_Producer").Caption = "供应商"
     TDBGrid1.Columns("B_Producer").width = 1000
     TDBGrid1.Columns("B_ProducerName").Caption = "供应商名称"
     TDBGrid1.Columns("B_kg").Caption = "公斤"
     TDBGrid1.Columns("B_kg").width = 950
          TDBGrid1.Columns("B_pishu").Caption = "匹数"
     TDBGrid1.Columns("B_pishu").width = 950
'     TDBGrid1.Columns("B_BoxQty").width = 0
'     TDBGrid1.Columns("B_BoxQty").Visible = False
'     TDBGrid1.Columns("B_BoxQty").AllowSizing = False
     TDBGrid1.Columns("B_Sum").width = 0
     TDBGrid1.Columns("B_Sum").Visible = False
     TDBGrid1.Columns("B_Sum").AllowSizing = False
     TDBGrid1.Columns("B_WhiteCategory").width = 0
     TDBGrid1.Columns("B_WhiteCategory").Visible = False
     TDBGrid1.Columns("B_WhiteCategory").AllowSizing = False
     TDBGrid1.Columns("B_positions").width = 0
     TDBGrid1.Columns("B_positions").Visible = False
     TDBGrid1.Columns("B_positions").AllowSizing = False
