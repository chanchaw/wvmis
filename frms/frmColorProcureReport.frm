...
Begin VB.Form frmColorProcureReport 
   Caption         =   "色布采购序时表"
   ClientHeight    =   7350
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   12965
      _DataPath       =   ""
      Bands           =   "frmColorProcureReport.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmColorProcureReport.frx":2916
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmColorProcureReport"
...
Private Sub cob1()
    ComboBox1.Clear
    ComboBox1.AddItem "色布采购入库"
    ComboBox1.AddItem "色布采购发货"
...
Private Sub chose()
    If ComboBox1.Text = "全部" Then
        ch = 2
    End If
    If ComboBox1.Text = "色布采购入库" Then
        ch = "COL20"
    End If
    If ComboBox1.Text = "色布采购发货" Then
        ch = "COL21"
    End If
End Sub
...
Private Sub Grid()
    ...
    sql = "exec usp_colorProcureReport '" & a & "','" & b & "','" & Originalsuppliers & "','" & ch & "','" & Gm.SysID.SystemUserName & "','" & m_DateFormat & "'"
    Debug.Print sql
    ...
    For i = 0 To TDBGrid1.Columns.Count - 1
        If TDBGrid1.Columns(i).width > 0 Then
            If TDBGrid1.Columns(i).Visible = True Then
                ...
                strSQL = "update G_BLSField set B_GridWidth='" & dWidth & "' where B_ObjectID='11S064' and B_FieldName='" & szFieldName & "'"
...
Private Sub TDBGrid1_DblClick()
    ...
    If Trim(rs!B_BillType) = "COL20" Then '染厂色布入库
        openbill rss!B_id
    End If
    If Trim(rs!B_BillType) = "COL21" Then '色布退染厂
        openbill1 rss!B_id
    End If
...
'        Exit Sub
'    End If
    Dim frm1 As New frmColorProcure
...
'        Exit Sub
'    End If
    Dim frm1 As New frmColorProcureDelivery
