...
Begin VB.Form frmProductProcureReport 
   Caption         =   "成品采购"
   ClientHeight    =   7260
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   12806
      _DataPath       =   ""
      Bands           =   "frmProductProcureReport.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmProductProcureReport.frx":23CC
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmProductProcureReport"
...
Private Sub grid()
    ...
    sql = "exec usp_ProductProcureReport '" & a & "','" & b & "','" & Originalsuppliers & "','" & ch & "','" & Gm.SysID.SystemUserName & "'"
    Debug.Print sql
    ...
    For i = 0 To TDBGrid1.Columns.Count - 1
        If TDBGrid1.Columns(i).width > 0 Then
            If TDBGrid1.Columns(i).Visible = True Then
                ...
                strSQL = "update G_BLSField set B_GridWidth='" & dWidth & "' where B_ObjectID='11S072' and B_FieldName='" & szFieldName & "'"
