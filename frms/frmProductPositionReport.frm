...
Begin VB.Form frmProductPositionReport 
   Caption         =   "成品转库单序时表"
   ClientHeight    =   7680
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   12806
      _DataPath       =   ""
      Bands           =   "frmProductPositionReport.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmProductPositionReport.frx":23CC
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmProductPositionReport"
...
Private Sub cob1()
'    ComboBox1.Clear
'    ComboBox1.AddItem "成品采购入库"
'    ComboBox1.AddItem "成品采购发货"
...
'        ch = 2
'    End If
'    If ComboBox1.Text = "成品采购入库" Then
'        ch = "PRO03"
'    End If
'    If ComboBox1.Text = "成品采购发货" Then
'        ch = "PRO04"
'    End If
    ch = ""
End Sub
...
Private Sub grid()
    ...
    sql = "exec usp_ProductPositionReport '" & a & "','" & b & "','" & Originalsuppliers & "','" & ch & "','" & Gm.SysID.SystemUserName & "'"
    Debug.Print sql
    ...
    For i = 0 To TDBGrid1.Columns.Count - 1
        If TDBGrid1.Columns(i).width > 0 Then
            If TDBGrid1.Columns(i).Visible = True Then
                ...
                strSQL = "update G_BLSField set B_GridWidth='" & dWidth & "' where B_ObjectID='11S080' and B_FieldName='" & szFieldName & "'"
...
Private Sub TDBGrid1_DblClick()
    ...
    If Trim(rs!B_BillType) = "PRO03" Then '染厂色布入库
        openbill rss!B_id
    End If
    If Trim(rs!B_BillType) = "PRO04" Then '色布退染厂
        openbill1 rss!B_id
    End If
...
'        Exit Sub
'    End If
    Dim frm1 As New frmProductProcure
...
'        Exit Sub
'    End If
    Dim frm1 As New frmProductProcureDelivery
