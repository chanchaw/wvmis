...
Begin VB.Form frmColorPositionReport 
   Caption         =   "色布转库单序时表"
   ClientHeight    =   7920
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   13970
      _DataPath       =   ""
      Bands           =   "frmColorPositionReport.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmColorPositionReport.frx":2E1C
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmColorPositionReport"
...
Private Sub Grid()
    ...
    sql = "exec usp_colorPositionReport '" & a & "','" & b & "','" & Originalsuppliers & "','" & ch & "','" & Gm.SysID.SystemUserName & "','" & m_DateFormat & "'"
    Debug.Print sql
    ...
    For i = 0 To TDBGrid1.Columns.Count - 1
        If TDBGrid1.Columns(i).width > 0 Then
            If TDBGrid1.Columns(i).Visible = True Then
                ...
                strSQL = "update G_BLSField set B_GridWidth='" & dWidth & "' where B_ObjectID='11S078' and B_FieldName='" & szFieldName & "'"
...
Private Sub TDBGrid1_DblClick()
    ...
    If Trim(rs!B_BillType) = "COL24" Then '染厂色布入库
        openbill rss!B_id
    End If
...
'        Exit Sub
'    End If
    Dim frm1 As New frmColorPosition
