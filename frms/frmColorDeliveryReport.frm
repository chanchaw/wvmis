...
Begin VB.Form frmColorDeliveryReport 
   Caption         =   "色布发货序时表"
   ClientHeight    =   7005
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   12356
      _DataPath       =   ""
      Bands           =   "frmColorDeliveryReport.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmColorDeliveryReport.frx":2F18
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmColorDeliveryReport"
...
Private m_DateFormat As Long   '选择日期格式
Private prtRS As New RecordSet    '筛选打印记录集
...
Private Sub Valuation()
    ComboBox1.AddItem "账目日期"
    ComboBox1.AddItem "制单日期"
    ComboBox1.Text = "制单日期"
    m_DateFormat = 0
End Sub
...
'Private Sub cob1()
'    ComboBox1.Clear
'    ComboBox1.AddItem "色布发客户"
'    ComboBox1.AddItem "客户退色布"
...
'        ch = 2
'    End If
'    If ComboBox1.Text = "色布发客户" Then
'        ch = "COL09"
'    End If
'    If ComboBox1.Text = "客户退色布" Then
'        ch = "COL11"
'    End If
'End Sub
...
'    chose
    ...
    sql = "exec usp_colordeliveryReport '" & a & "','" & b & "','" & Originalsuppliers & "','" & FlatEdit1.Text & "','" & FlatEdit2.Text & "','" & Gm.SysID.SystemUserName & "','" & m_DateFormat & "'"
    Debug.Print sql
    ...
    For i = 0 To TDBGrid1.Columns.Count - 1
        If TDBGrid1.Columns(i).width > 0 Then
            If TDBGrid1.Columns(i).Visible = True Then
                ...
                strSQL = "update G_BLSField set B_GridWidth='" & dWidth & "' where B_ObjectID='11S041' and B_FieldName='" & szFieldName & "'"
...
Private Sub TDBGrid1_DblClick()
    ...
    If Trim(rs!B_BillType) = "COL09" Then '色布发客户
        openbill rss!B_id
    End If
    If Trim(rs!B_BillType) = "COL11" Then '客户退色布
        openbill1 rss!B_id
    End If
    If Trim(rs!B_BillType) = "COL23" Then '客户退色布
        openbill2 rss!B_id
    End If
...
Private Sub openbill(ByVal id As String)
    ...
    a = TDBGrid1.bookmark
     Dim rs As New RecordSet
    Dim sql As String
   sql = "select  B_id,B_CodeID,B_Date,B_Freight,a.B_Contacts,a.B_Telephone,B_PlateNumber,B_PNumber,B_payment,B_Shipment,b.B_ClientName,B_Hand,c.B_Name,B_cope,B_Freighttelephone,B_drivename,B_CostPay"
...
'        Exit Sub
'    End If
    Dim frm1 As New frmColorDelivery
    frm1.Text1.Text = IIf(IsNull(rs!B_Contacts), "", rs!B_Contacts)
    frm1.Text2.Text = IIf(IsNull(rs!B_Telephone), "", rs!B_Telephone)
     frm1.id = rs!B_id
...
'        Exit Sub
'    End If
    Dim frm1 As New frmColorClientReturn
...
'        Exit Sub
'    End If
    Dim frm1 As New frmColorDeliveryReturn
...
Private Sub setNumberColDisable()
'    TDBGrid1.Columns("B_KG")
End Sub
