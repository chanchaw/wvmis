...
Begin VB.Form frmOrderColorReport 
   Caption         =   "色布采购查询"
   ClientHeight    =   7365
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   13044
      _DataPath       =   ""
      Bands           =   "frmOrderColorReport.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmOrderColorReport.frx":1028
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmOrderColorReport"
...
Private Sub Grid()
    ...
    sql = "exec usp_SelectColororder_Edit '" & a & "','" & b & "'"
...
Private Sub setgrid()
   TDBGrid1.Columns("B_ItemIDB").Caption = "订单号"
    ...
    TDBGrid1.Columns("B_ps").width = 800
    TDBGrid1.Columns("B_kg").width = 800
