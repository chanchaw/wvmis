...
Begin VB.Form frmpopupOriginal 
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   11642
      _DataPath       =   ""
      Bands           =   "frmpopupOriginal.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmpopupOriginal.frx":085A
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmpopupOriginal"
...
Private thespecifications As String
Private theSupplier As String
...
End Property
Public Property Get specifications() As String
    specifications = thespecifications
End Property
...
Private Sub SelectClientID()
  If rsClient.RecordCount > 0 Then
    theOrderCode = IIf(IsNull(rsClient!B_OrderCode), "", rsClient!B_OrderCode)
    thespecifications = IIf(IsNull(rsClient!B_specification), "", rsClient!B_specification)
    theSupplier = IIf(IsNull(rsClient!B_Clientid), "", rsClient!B_Clientid)
    theClientName = IIf(IsNull(rsClient!B_ClientName), "", rsClient!B_ClientName)
...
Private Sub setstyle()
     ...
     TDBGrid1.Columns("B_LotNumber").width = 0
     TDBGrid1.Columns("B_LotNumber").Visible = False
     TDBGrid1.Columns("B_LotNumber").AllowSizing = False
