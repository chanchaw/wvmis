...
Begin VB.Form frmStorageQueryColor 
   Caption         =   "色布仓库"
   ClientHeight    =   6555
   ClientLeft      =   120
   ClientTop       =   450
   ...
   EndProperty
   Icon            =   "frmStorageQueryColor.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   6555
   ScaleWidth      =   10485
   ...
   Begin C1SizerLibCtl.C1Elastic C1Elastic1 
      ...
      FloodStyle      =   1
      _GridInfo       =   $"frmStorageQueryColor.frx":058A
      AccessibleName  =   ""
      ...
      Begin C1SizerLibCtl.C1Tab C1Tab1 
         ...
         AccessibleValue =   ""
         AccessibleRole  =   37
         Picture(0)      =   "frmStorageQueryColor.frx":0610
         Picture(1)      =   "frmStorageQueryColor.frx":09AA
         Flags(1)        =   2
         Begin C1SizerLibCtl.C1Elastic C1Elastic2 
            ...
            FrameShadow     =   -2147483632
            FloodStyle      =   1
            _GridInfo       =   $"frmStorageQueryColor.frx":0F44
            AccessibleName  =   ""
            AccessibleDescription=   ""
            AccessibleValue =   ""
            AccessibleRole  =   9
         ...
         Begin C1SizerLibCtl.C1Elastic C1Elastic3 
            ...
            FrameShadow     =   -2147483632
            FloodStyle      =   1
            _GridInfo       =   $"frmStorageQueryColor.frx":0FDD
            AccessibleName  =   ""
            AccessibleDescription=   ""
            AccessibleValue =   ""
            AccessibleRole  =   9
   ...
   End
End
Attribute VB_Name = "frmStorageQueryColor"
...
'下面是相关的常量
Private Const A_Storage As String = "色布仓库"
Private Const strSQLInv As String = "exec dbo.[usp_InvColor] '',''" '库存存储过程
Private Const strSQLInvSpend As String = "" '领料库存
Private Const A_BLObjectID As String = "12B007" '根据该单据对象的设置，将非数量的字段锁定为不可修改
Private Const A_BLObjectIDCreated As String = "12B008"   '被生成的单据对象编号
Private Const A_GridStyleObjectID As String = "13B012"  '设置网格显示用到的对象
