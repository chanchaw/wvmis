...
Begin VB.Form frmWhiteProcessInset_Edit 
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   12118
      _DataPath       =   ""
      Bands           =   "frmWhiteProcessInset_Edit.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmWhiteProcessInset_Edit.frx":12A2
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmWhiteProcessInset_Edit"
...
Private Sub grid()
    ...
    sql = "exec usp_frmWhiteProcessInset_Edit '" & FlatEdit1.Text & "'"
