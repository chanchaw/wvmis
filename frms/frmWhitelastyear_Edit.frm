...
Begin VB.Form frmWhitelastyear_Edit 
   Caption         =   "白坯上年度查询"
   ClientHeight    =   6495
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   11456
      _DataPath       =   ""
      Bands           =   "frmWhitelastyear_Edit.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmWhitelastyear_Edit.frx":085A
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmWhitelastyear_Edit"
...
Private Sub Grid()
    ...
    sql = "exec usp_selectWhitelastyear"
...
Private Sub SetGrid()
    ...
    TDBGrid1.Columns("B_ClientName").Caption = "加工商"
