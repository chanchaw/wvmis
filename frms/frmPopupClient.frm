...
Begin VB.Form frmPopupClient 
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmPopupClient.frx":0DE4
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmPopupClient"
...
Private Sub GetClient()
    ...
    strSQL = "Select B_ClientID,B_ClientName,B_Alias From G_ContactCompany Where B_ContactType='客户'"
...
Private Sub setstyle()
     ...
     TDBGrid1.Columns("B_ClientID").Caption = "客户编号"
     TDBGrid1.Columns("B_ClientName").Caption = "客户名"
'     TDBGrid1.Columns("B_ContactType").Caption = "客户类别"
     TDBGrid1.Columns("B_Alias").Caption = "别名"
    
    TDBGrid1.Columns("B_Alias").width = 1500
'    TDBGrid1.Columns("B_ContactType").width = 2000
    TDBGrid1.Columns("B_ClientID").Alignment = dbgLeft
    TDBGrid1.Columns("B_ClientName").Alignment = dbgLeft
    TDBGrid1.Columns("B_Alias").Alignment = dbgLeft
