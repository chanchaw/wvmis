...
Begin VB.Form frmModBLSColor 
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   10213
      _DataPath       =   ""
      Bands           =   "frmModBLSColor.frx":0000
      Begin DDSharpGridOLEDB2U.SGGrid SGGrid1 
         Bindings        =   "frmModBLSColor.frx":6A24
         Height          =   1395
         Left            =   240
         TabIndex        =   2
         Top             =   2040
         ...
         Format          =   "frmModBLSColor.frx":6A39
         Caption         =   "frmModBLSColor.frx":6A6B
         ScrollTipColumn =   "frmModBLSColor.frx":6A8F
         GroupByBoxText  =   "frmModBLSColor.frx":6AB3
         StylesCollection=   "frmModBLSColor.frx":6B39
         ColumnsCollection=   "frmModBLSColor.frx":A6E1
         ValueItems      =   "frmModBLSColor.frx":C3CB
      End
      Begin MSAdodcLib.Adodc Adodc1 
         ...
         _Version        =   393216
      End
      Begin DDSharpGridOLEDB2U.SGGrid SGGrid11 
         Height          =   2715
         Left            =   3840
         TabIndex        =   1
         Top             =   3840
         ...
         AutoSearch      =   0
         AutoSearchDelay =   2000
         Format          =   "frmModBLSColor.frx":CD65
         Caption         =   "frmModBLSColor.frx":CD97
         ScrollTipColumn =   "frmModBLSColor.frx":CDBB
         GroupByBoxText  =   "frmModBLSColor.frx":CDDF
         StylesCollection=   "frmModBLSColor.frx":CE65
         ColumnsCollection=   "frmModBLSColor.frx":10A07
         ValueItems      =   "frmModBLSColor.frx":126F1
      End
   End
End
Attribute VB_Name = "frmModBLSColor"
...
'        SGGrid1.ReBind
    ...
    SGGrid1.SelectionMode = sgSelectionNone
...
Private Sub setColor()
     ...
     If oRow.Position > 0 Then
        Set rs = New RecordSet
        Dim sql As String
        sql = "select B_Red,B_Green,B_Blue from G_Color where B_SID='" & oRow.Cells(1) & "'"
        Debug.Print sql
        ...
        lys = RGBToLong(ys)
        Debug.Print lys
        oRow.Cells(6).Style.BackColor = lys
        'oRow.Cells(1).Style.BackColor = vbRed
        Debug.Print oRow.Cells(6).Value
     End If
     Next
...
'        ys.Red = Adodc1.RecordSet!B_Red
'        ys.Green = Adodc1.RecordSet!B_Green
'        ys.Blue = Adodc1.RecordSet!B_Blue
'        lys = RGBToLong(ys)
'        Adodc1.RecordSet!B_Color = lys
'    Loop
'
End Sub
