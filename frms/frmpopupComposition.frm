...
Begin VB.Form frmpopupComposition 
   ...
   EndProperty
   Icon            =   "frmpopupComposition.frx":0000
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6165
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   10874
      _DataPath       =   ""
      Bands           =   "frmpopupComposition.frx":038A
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmpopupComposition.frx":0BE4
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmpopupComposition"
...
Private theCompositionID As String
Private theCompositionName As String
Private theAlias As String

Public Property Get Compositionid() As String
    Compositionid = theCompositionID
End Property

Public Property Get CompositionName() As String
    CompositionName = theCompositionName
End Property
...
Private Sub GetClient()
    ...
    strSQL = "Select B_SID,B_Name From G_Yarn Where 1=1"
...
Private Sub SelectClientID()
    theCompositionID = rsClient!B_sid
    theCompositionName = rsClient!B_name
...
Private Sub setstyle()
     ...
     TDBGrid1.Columns("B_SID").Caption = "原料编号"
     TDBGrid1.Columns("B_Name").Caption = "原料名称"
'     TDBGrid1.Columns("B_ContactType").Caption = "制作人"
