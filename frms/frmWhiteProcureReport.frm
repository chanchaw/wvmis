...
Begin VB.Form frmWhiteProcureReport 
   Caption         =   "白坯采购序时表"
   ClientHeight    =   7395
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   13044
      _DataPath       =   ""
      Bands           =   "frmWhiteProcureReport.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmWhiteProcureReport.frx":23CC
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmWhiteProcureReport"
...
Private Sub grid()
    ...
    sql = "exec usp_whiteprocurereport '" & a & "','" & b & "','" & FlatEdit1.Text & "','" & Originalsuppliers & "','" & Gm.SysID.SystemUserName & "'"
    Debug.Print sql
    ...
    For i = 0 To TDBGrid1.Columns.Count - 1
        If TDBGrid1.Columns(i).width > 0 Then
            If TDBGrid1.Columns(i).Visible = True Then
                ...
                strSQL = "update G_BLSField set B_GridWidth='" & dWidth & "' where B_ObjectID='11S052' and B_FieldName='" & szFieldName & "'"
...
Private Sub sumall()
    ...
    Do While Not rs.EOF
        ...
        e = e + IIf(IsNull(rs!B_sum), 0, rs!B_sum)
        rs.movenext
    Loop
'    c = Format(a, "0.0")
    d = Format(b, "0.0")
    ...
    TDBGrid1.Columns("B_sum").FooterText = "" & f & ""
End Sub
Private Sub sumall1()
    Dim Sum As Double
    Dim Sum2 As Double
    ...
    For i = 1 To n
        ...
        Sum3 = Sum3 + Val(TDBGrid1.Columns("B_sum").Text)
        TDBGrid1.movenext
    Next i
    TDBGrid1.Columns("B_PIShu").FooterText = "" & Sum & ""
    TDBGrid1.Columns("B_KG").FooterText = "" & Sum2 & ""
    TDBGrid1.Columns("B_sum").FooterText = "" & Sum3 & ""
End Sub
