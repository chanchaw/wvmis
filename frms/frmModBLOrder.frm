...
Begin VB.Form frmModBLOrder 
   ...
   Begin C1SizerLibCtl.C1Elastic C1Elastic1 
      ...
      FloodStyle      =   1
      _GridInfo       =   $"frmModBLOrder.frx":038A
      AccessibleName  =   ""
      ...
      Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
         ...
         _ExtentY        =   8440
         _DataPath       =   ""
         Bands           =   "frmModBLOrder.frx":C4A8
         Begin TrueOleDBGrid80.TDBGrid TDBGrid1 
            Bindings        =   "frmModBLOrder.frx":C670
            Height          =   4515
            Left            =   600
            TabIndex        =   12
            Top             =   240
   ...
   End
End
Attribute VB_Name = "frmModBLOrder"
...
Public Function IsSaved() As Boolean
    IsSaved = ABMenu.Bands("Band1").Tools("登帐标记").Visible
End Function

'生成辅料计划
Private Sub CreateAccePlan()
    If IsSaved = False Then
        MsgBox "保存之后再做生成！", vbOKOnly + vbInformation, "提示"
        Exit Sub
    End If
...
Private Sub CreateAccessory()
    ...
    '订单主表字段B_ID
    lID = clsBL1.m_ID
    szPactCode = Me.Controls("B_PactCode").Text
