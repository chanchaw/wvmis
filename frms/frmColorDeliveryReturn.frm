...
Begin VB.Form frmColorDeliveryReturn 
   Caption         =   "本厂退客户"
   ClientHeight    =   7815
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   13785
      _DataPath       =   ""
      Bands           =   "frmColorDeliveryReturn.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmColorDeliveryReturn.frx":5C4E
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmColorDeliveryReturn"
...
'        End If
        ...
        Else
            ...
            MsgBox "第" & i & "行匹数,公斤,米数三者有一个不能为空", vbInformation, "提示"
            Exit Sub
        End If
    ...
    sql1 = sql1 & "'12B013','COL23','" & Gm.SysID.SystemUser & "','" & FlatEdit2.Text & "'"
...
Private Sub MoveFirst()
    ...
    sql = sql & " left outer join G_Employee c on a.B_Hand=c.B_SID where B_ObjectID='12B013' and  B_BillType='COL23'"
...
Private Sub MovePrevious()
    ...
    sql = sql & " from G_Billcolor a left outer join G_ContactCompany b on a.B_Shipment=b.B_ClientID"
    sql = sql & " left outer join G_Employee c on a.B_Hand=c.B_SID where B_ObjectID='12B013' and  B_BillType='COL23' and B_ID<'" & id & "'"
