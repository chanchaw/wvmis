...
Begin VB.Form frmPopupDanWei1 
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   11113
      _DataPath       =   ""
      Bands           =   "frmPopupDanWei1.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmPopupDanWei1.frx":085A
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmPopupDanWei1"
...
Private Sub GetClient()
    ...
    strSQL = "Select B_ClientID,B_ClientName From G_ContactCompany Where B_ContactType in ( '白坯加工商','白坯供应商')"
    Debug.Print strSQL
