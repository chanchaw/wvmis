...
Begin VB.Form frmWhiteSumRepoart_ALL 
   Caption         =   "加工结算汇总表"
   ClientHeight    =   7515
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   13282
      _DataPath       =   ""
      Bands           =   "frmWhiteSumRepoart_ALL.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmWhiteSumRepoart_ALL.frx":18F8
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmWhiteSumRepoart_ALL"
...
Private Sub grid()
    ...
    sql = "exec [usp_WhiteSumAll] '" & a & "','" & b & "','" & prcessid & "','" & Originalsuppliers & "'"
    Debug.Print sql
