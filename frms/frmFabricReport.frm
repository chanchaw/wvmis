...
Begin VB.Form frmWhiteFabricReport 
   Caption         =   "白坯车间次布"
   ClientHeight    =   6855
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   12674
      _DataPath       =   ""
      Bands           =   "frmFabricReport.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmFabricReport.frx":17A8
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmWhiteFabricReport"
...
Private Sub grid()
    ...
    sql = "exec usp_WhiteFabricReport '" & a & "','" & b & "','" & FlatEdit1.Text & "','" & FlatEdit2.Text & "','" & Gm.SysID.SystemUser & "','" & ch & "'"
    Debug.Print sql
...
Private Sub printwhite()
    ...
    Dim sql As String
    sql = "exec usp_WhiteFabricReport '" & a & "','" & b & "','" & FlatEdit1.Text & "','" & FlatEdit2.Text & "','" & Gm.SysID.SystemUserName & "','" & ch & "'"
    Debug.Print sql
    ...
    For i = 0 To TDBGrid1.Columns.Count - 1
        If TDBGrid1.Columns(i).width > 0 Then
            If TDBGrid1.Columns(i).Visible = True Then
                ...
                strSQL = "update G_BLSField set B_GridWidth='" & dWidth & "' where B_ObjectID='11S022' and B_FieldName='" & szFieldName & "'"
...
Private Sub sumall()
    ...
    Do While Not rss.EOF
        a = a + IIf(IsNull(rss!B_kg), 0, rss!B_kg)
        rss.movenext
    Loop
    rss.MoveFirst
    b = Format(a, "0.0")
