...
Begin VB.Form frmOriginalOrderInsetReport 
   Caption         =   "原料入库序时表"
   ClientHeight    =   7395
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   13044
      _DataPath       =   ""
      Bands           =   "frmOriginalOrderInsetReport.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmOriginalOrderInsetReport.frx":2916
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmOriginalOrderInsetReport"
...
Private Sub cob1()
    ComboBox1.Clear
    ComboBox1.AddItem "原料入库"
    ComboBox1.AddItem "采购退货"
...
Private Sub chose()
    If ComboBox1.Text = "全部" Then
        ch = 2
    End If
    If ComboBox1.Text = "原料入库" Then
        ch = "YARN02"
    End If
    If ComboBox1.Text = "采购退货" Then
        ch = "YARN03"
    End If
End Sub
'双击打开打开原单
Private Sub TDBGrid1_DblClick()
    ...
    If rs!B_BillType = "YARN02" Then
        openbill rss!B_id
    End If
    If rs!B_BillType = "YARN03" Then
        openbill1 rss!B_id
    End If
...
'        Exit Sub
'    End If
    Dim frm1 As New frmOriginalOrderInset
    frm1.id = rs!B_id
...
Private Sub Grid()
    ...
    sql = "exec usp_OriginalOrderInsetReport '" & a & "','" & b & "','" & Originalsuppliers & "','" & ch & "','" & Gm.SysID.SystemUserName & "','" & m_DateFormat & "'"
    Debug.Print sql
    ...
    For i = 0 To TDBGrid1.Columns.Count - 1
        If TDBGrid1.Columns(i).width > 0 Then
            If TDBGrid1.Columns(i).Visible = True Then
                ...
                strSQL = "update G_BLSField set B_GridWidth='" & dWidth & "' where B_ObjectID='11S034' and B_FieldName='" & szFieldName & "'"
...
Private Sub sumall1()
    ...
    For i = 1 To n
        ...
        Sum2 = Sum2 + Val(TDBGrid1.Columns("B_Sum").Text)
        TDBGrid1.movenext
    Next i
    TDBGrid1.Columns("sum2").FooterText = "" & Sum & ""
    TDBGrid1.Columns("B_Sum").FooterText = "" & Sum2 & ""
End Sub
