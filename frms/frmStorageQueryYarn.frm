...
Begin VB.Form frmStorageQueryYarn 
   Caption         =   "原料仓库综合管理"
   ClientHeight    =   7230
   ClientLeft      =   120
   ClientTop       =   450
   ...
   EndProperty
   Icon            =   "frmStorageQueryYarn.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   7230
   ScaleWidth      =   11235
   ...
   Begin C1SizerLibCtl.C1Elastic C1Elastic1 
      ...
      FloodStyle      =   1
      _GridInfo       =   $"frmStorageQueryYarn.frx":058A
      AccessibleName  =   ""
      ...
      Begin C1SizerLibCtl.C1Tab C1Tab1 
         ...
         AccessibleValue =   ""
         AccessibleRole  =   37
         Picture(0)      =   "frmStorageQueryYarn.frx":0610
         Picture(1)      =   "frmStorageQueryYarn.frx":09AA
         Flags(1)        =   2
         Begin C1SizerLibCtl.C1Elastic C1Elastic2 
            ...
            FrameShadow     =   -2147483632
            FloodStyle      =   1
            _GridInfo       =   $"frmStorageQueryYarn.frx":0F44
            AccessibleName  =   ""
            AccessibleDescription=   ""
            AccessibleValue =   ""
            AccessibleRole  =   9
         ...
         Begin C1SizerLibCtl.C1Elastic C1Elastic3 
            ...
            FrameShadow     =   -2147483632
            FloodStyle      =   1
            _GridInfo       =   $"frmStorageQueryYarn.frx":0FDD
            AccessibleName  =   ""
            AccessibleDescription=   ""
            AccessibleValue =   ""
            AccessibleRole  =   9
   ...
   End
End
Attribute VB_Name = "frmStorageQueryYarn"
...
'下面是相关的常量
Private Const A_Storage As String = "原料仓库"
Private Const strSQLInv As String = "exec dbo.[usp_InvYarn] '',''" '库存存储过程
Private Const strSQLInvSpend As String = "" '领料库存
Private Const A_BLObjectID As String = "12B003" '根据该单据对象的设置，将非数量的字段锁定为不可修改
Private Const A_BLObjectIDCreated As String = "12B004"   '被生成的单据对象编号
Private Const A_GridStyleObjectID As String = "13B006"  '设置网格显示用到的对象
...
Private Sub GetInv()
    ...
    TDBGInv.Columns("B_Sum").AllowSizing = False
...
Private Sub Combo1_Click()
    ...
    If Combo1.Text = "外发加工" Then
        ...
        Unload frm1
    End If
    If Combo1.Text = "采购退货单" Then
        Dim frm2 As New frmPopupDanWei
        frm2.ContactType = "原料供应商"
        frm2.Show vbModal
        Originalsuppliers = frm2.Clientid
        FlatEdit1.Text = frm2.ClientName
        Unload frm2
    End If
    If Combo1.Text <> "外发加工" And Combo1.Text <> "采购退货单" Then
        FlatEdit1.Text = ""
        Originalsuppliers = ""
    End If
...
Private Sub CreateBL(ByVal vBillType As String, ByRef vRsWait As RecordSet)
    ...
    rsBill!B_ContactCom = rsWait!B_Clientid
    ...
    rsDetail.Fields.Append "B_LotNumber", adVarChar, 100
    
    rsDetail.Fields.Append "B_OrderCode", adVarChar, 100
    rsDetail.Fields.Append "B_specification", adVarChar, 100
    rsDetail.Fields.Append "B_Positions", adVarChar, 100
'    rsDetail.Fields.Append "B_ContactCom", adVarChar, 100
    ...
    Do While Not rsWait.EOF
        ...
        rsDetail!B_OrderCode = rsWait!B_OrderCode
        rsDetail!B_specification = rsWait!B_specification
        rsDetail!B_Positions = rsWait!B_Positions
'        rsDetail!B_ContactCom = rsWait!B_ContactCom
        
        rsDetail!B_LotNumber = rsWait!B_LotNumber
        'rsDetail!B_Specification = rsWait!B_Specification
