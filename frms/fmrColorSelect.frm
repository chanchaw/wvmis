...
Begin VB.Form fmrColorSelect 
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"fmrColorSelect.frx":0E50
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "fmrColorSelect"
...
'    chose
    ...
    sql = "exec usp_SelectBillColor '" & a & "','" & b & "','" & FlatEdit3.Text & "','" & Originalsuppliers & "'"
    Debug.Print sql
...
Private Sub setgrid()
    ...
    TDBGrid1.Columns("B_departname").Caption = "染厂名称"
    TDBGrid1.Columns("B_kg").Caption = "公斤"
    TDBGrid1.Columns("B_meter").Caption = "米数"
    TDBGrid1.Columns("B_color").Caption = "颜色"


    TDBGrid1.Columns("B_PactCode").width = 1000
    TDBGrid1.Columns("B_ItemIDB").width = 1000
    TDBGrid1.Columns("B_kg").width = 1000
    TDBGrid1.Columns("B_meter").width = 1000
    TDBGrid1.Columns("B_ClientName").width = 2200

    TDBGrid1.Columns("B_goodsnameALias").width = 2200
