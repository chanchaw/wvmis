...
Begin VB.Form frmOriginalOrderInsetReport_CaiGou 
   Caption         =   "原料采购序时表"
   ClientHeight    =   7800
   ClientLeft      =   120
   ClientTop       =   450
   ...
   EndProperty
   Icon            =   "frmOriginalOrderInsetReport_CaiGou.frx":0000
   LinkTopic       =   "Form2"
   MDIChild        =   -1  'True
   ScaleHeight     =   7800
   ScaleWidth      =   10920
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   13758
      _DataPath       =   ""
      Bands           =   "frmOriginalOrderInsetReport_CaiGou.frx":058A
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmOriginalOrderInsetReport_CaiGou.frx":2070
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmOriginalOrderInsetReport_CaiGou"
...
Private Sub Grid()
    ...
    sql = "exec usp_OriginalOrderInsetReport_CaiGou '" & a & "','" & b & "','" & Originalsuppliers & "','" & ch & "','" & Gm.SysID.SystemUserName & "','" & m_DateFormat & "'"
    Debug.Print sql
