...
Begin VB.Form frmwhiteprocess_Sum 
   Caption         =   "外发加工白坯入库汇总"
   ClientHeight    =   7650
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   12012
      _DataPath       =   ""
      Bands           =   "frmOriginalOrderInset_Sum.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmOriginalOrderInset_Sum.frx":1320
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmwhiteprocess_Sum"
...
Private Sub Grid()
    ...
    Dim sql As String
    sql = "exec usp_whiteprocess_Sum '" & a & "','" & b & "','" & FlatEdit1.Text & "','" & Originalsuppliers & "'"
    ...
    For i = 0 To TDBGrid1.Columns.Count - 1
        If TDBGrid1.Columns(i).width > 0 Then
            If TDBGrid1.Columns(i).Visible = True Then
                ...
                strSQL = "update G_BLSField set B_GridWidth='" & dWidth & "' where B_ObjectID='11S019' and B_FieldName='" & szFieldName & "'"
...
Private Sub sumall()
    ...
    Do While Not rss.EOF
        a = a + IIf(IsNull(rss!B_PIShu), 0, rss!B_PIShu)
