...
Begin VB.Form frmWhiteProcure_Edit 
   Caption         =   "白坯采购查询"
   ClientHeight    =   7425
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   11351
      _DataPath       =   ""
      Bands           =   "frmWhiteProcure_Edit.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmWhiteProcure_Edit.frx":12A2
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmWhiteProcure_Edit"
...
Private Sub grid()
    ...
    sql = "exec usp_selectWhiteprocure '" & FlatEdit1.Text & "'"
