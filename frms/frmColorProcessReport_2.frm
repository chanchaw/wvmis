...
Begin VB.Form frmColorProcessReport_2 
   Caption         =   "色布退和深加工回修"
   ClientHeight    =   7860
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   19315
      _DataPath       =   ""
      Bands           =   "frmColorProcessReport_2.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmColorProcessReport_2.frx":1AE6
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmColorProcessReport_2"
...
Private Sub Grid()
    ...
    sql = "exec usp_colorprocessReport_2 '" & a & "','" & b & "','" & Originalsuppliers & "','" & ch & "','" & Gm.SysID.SystemUserName & "','" & whitecolor & "'"
    Debug.Print sql
