...
Begin VB.Form frmWhiteProcessInset 
   Caption         =   "白坯加工出入库"
   ClientHeight    =   7455
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   13150
      _DataPath       =   ""
      Bands           =   "frmWhiteProcessInset.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmWhiteProcessInset.frx":59F2
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmWhiteProcessInset"
...
Private Sub setRs()
    ...
    rsdetail.Fields.Append "B_KxOutDingDanHao", adVarChar, 100
    ...
    For i = 0 To TDBGrid1.Columns.Count - 1
        If TDBGrid1.Columns(i).width > 0 Then
            If TDBGrid1.Columns(i).Visible = True Then
                ...
                strSQL = "update G_BLSField set B_GridWidth='" & dWidth & "' where B_ObjectID='11S014' and B_FieldName='" & szFieldName & "'"
...
'        End If
    ...
    sql1 = sql1 & "'12B005','WHT04 ','" & Gm.SysID.SystemUser & "','" & FlatEdit2.Text & "'"
...
Private Sub savetoupdate1()
    ...
    Do While Not rsdetail.EOF
        ...
        If rs3.RecordCount > 0 Then
            sql2 = "exec usp_whiteprocessdetail_update '" & rsdetail!B_itemid & "','" & id & "','" & rsdetail!B_ItemIDB & "','" & rsdetail!B_supplierid & "'"
            sql2 = sql2 & ",'" & rsdetail!B_whiteid & "','" & rsdetail!B_Width & "','" & rsdetail!B_weight & "','" & rsdetail!B_PIShu & "'"
            sql2 = sql2 & ",'" & rsdetail!B_kg & "','" & rsdetail!B_Cang & "','" & rsdetail!B_processid & "','" & rsdetail!B_memo & "','" & rsdetail!B_supplement & "','" & rsdetail!B_price & "','" & rsdetail!B_sum & "','" & rsdetail!B_qty & "','" & rsdetail!B_DeliveryNote & "','" & rsdetail!B_Waitfreight & "','" & rsdetail!B_Freight & "','" & rsdetail!B_Prepaidfreight & "','" & rsdetail!B_YarnSpecification & "','" & rsdetail!B_originalitemidb & "','" & rsdetail!B_Clientid & "','" & rsdetail!B_KxOutDingDanHao & "'"
...
Private Sub saveandprint(ByVal dy As Long)
    Dim rrs As New RecordSet
    Dim strSQL As String
...
'        End If
    ...
    End If
        ...
        If dy = 0 Then
            frm1.ObjectID = "22B032"
        End If
        If dy = 1 Then
              frm1.ObjectID = "22B091"
        End If
        frm1.Show
...
Private Sub MoveFirst()
    ...
    sql = sql & " left outer join G_Employee c on a.B_Hand=c.B_SID where B_ObjectID='12B005' and  B_BillType='WHT04'"
...
Private Sub MovePrevious()
    ...
    sql = sql & " from G_BillWhite a left outer join G_ContactCompany b on a.B_Shipment=b.B_ClientID"
    sql = sql & " left outer join G_Employee c on a.B_Hand=c.B_SID where B_ObjectID='12B005' and  B_BillType='WHT04' and B_ID<'" & id & "'"
...
Public Sub openbill()
   Dim sql As String
   Dim rs As New RecordSet
   sql = "select B_ItemID,B_ItemIDB,a.B_KxOutDingDanHao,B_Producer,b.B_ClientName as B_client,B_GoodsID,c.B_Name,B_Width,B_UnitWeight,B_pishu,B_kg,B_cang,B_Supplier,d.B_ClientName,B_MemoDetail,B_supplement,a.B_Price,B_sum,B_qty,B_DeliveryNote,B_Waitfreight,B_freight,B_Prepaidfreight,B_YarnSpecification,B_originalitemidb,a.B_Clientid,e.B_ClientName as B_clientkh"
   ...
   Do While Not rs.EOF
       ...
       rsdetail!B_KxOutDingDanHao = IIf(IsNull(rs!B_KxOutDingDanHao), "", rs!B_KxOutDingDanHao)
