...
Begin VB.Form frmPopupitemidb 
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   13123
      _DataPath       =   ""
      Bands           =   "frmPopupitemidb.frx":058A
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmPopupitemidb.frx":1AF0
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmPopupitemidb"
...
Private Sub Grid()
    ...
    sql = "exec usp_SelectSourceOrderCode '" & clientid & "','" & Text1.Text & "'"
    Debug.Print sql
