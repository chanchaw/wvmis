...
Begin VB.Form frmColorProcure_Edit 
   Caption         =   "色布采购计划"
   ClientHeight    =   6735
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   11880
      _DataPath       =   ""
      Bands           =   "frmColorProcure_Edit.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmColorProcure_Edit.frx":12A2
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmColorProcure_Edit"
...
Public Sub Grid()
    ...
    sql = "exec usp_SelectProcure '" & Trim(FlatEdit1.Text) & "'"
