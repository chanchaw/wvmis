...
Begin VB.Form frmColorJRKprintDetail_FaHuo 
   Caption         =   "选择对应的发货单"
   ClientHeight    =   7365
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   13785
      _DataPath       =   ""
      Bands           =   "frmColorJRKprintDetail_FaHuo.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmColorJRKprintDetail_FaHuo.frx":159A
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmColorJRKprintDetail_FaHuo"
...
Public m_Judeg As Boolean
Public m_ItemID As String
...
Public Sub openbill()
   ...
   sql = sql & " where isnull(B_FaHuoOver,0)=1 AND B_ItemIDB='" & m_DingDanHao & "'"
   Debug.Print sql
   ...
   Do While Not rs.EOF
       ...
       rsdetail!B_allmoney = IIf(IsNull(rs!B_DanJia), 0, rs!B_DanJia) * IIf(IsNull(rs!B_kg), 0, rs!B_kg)
       rsdetail.Update
       rs.movenext
   Loop
rsdetail.MoveFirst
