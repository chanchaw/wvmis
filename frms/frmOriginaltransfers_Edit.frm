...
Begin VB.Form frmOriginaltransfers_Edit 
   Caption         =   "原料调拨查询"
   ClientHeight    =   7530
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   13282
      _DataPath       =   ""
      Bands           =   "frmOriginaltransfers_Edit.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmOriginaltransfers_Edit.frx":12A2
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmOriginaltransfers_Edit"
...
Private Sub grid()
    ...
    sql = "exec usp_selectOriginaltransfers '" & FlatEdit1.Text & "','','1'"
    Debug.Print sql
...
Private Sub setgrid()
    ...
    TDBGrid1.Columns("sum2").Caption = "数量"
