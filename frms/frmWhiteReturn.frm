...
Begin VB.Form frmWhiteReturn 
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmWhiteReturn.frx":51E4
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmWhiteReturn"
...
Private Sub save()
    ...
    sql1 = sql1 & "'12B006','WHT06 ','" & Gm.SysID.SystemUser & "','" & FlatEdit2.Text & "'"
...
Private Sub savedetail()
    ...
    Do While Not rsdetail.EOF
        ...
        sql2 = "exec usp_whitedeliveryinsert '" & item & "','" & id & "','" & rsdetail!B_ItemIDB & "'"
...
Private Sub MoveFirst()
    ...
    sql = sql & " left outer join G_Employee c on a.B_Hand=c.B_SID where B_ObjectID='12B006' and  B_BillType='WHT06'"
...
Private Sub MovePrevious()
    ...
    sql = sql & " from G_BillWhite a left outer join G_ContactCompany b on a.B_Shipment=b.B_ClientID"
    sql = sql & " left outer join G_Employee c on a.B_Hand=c.B_SID where B_ObjectID='12B006' and  B_BillType='WHT06' and B_ID<'" & id & "'"
...
Public Sub openbill()
   Dim sql As String
   Dim rs As New RecordSet
   sql = "select B_ItemID,B_ItemIDB,B_GoodsID,b.B_Name,B_Width,B_UnitWeight,B_pishu,B_kg,B_Supplier,c.B_ClientName, B_MemoDetail,B_Waitfreight,B_freight,B_Prepaidfreight,B_YarnSpecification,e.B_ClientName as B_clientkh,a.B_Clientid"
