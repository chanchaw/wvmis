...
Begin VB.Form frmOriginalOrderInset 
   Caption         =   "原料入库"
   ClientHeight    =   7455
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   13150
      _DataPath       =   ""
      Bands           =   "frmOriginalOrderInset.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmOriginalOrderInset.frx":51E4
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmOriginalOrderInset"
    ...
    For i = 0 To TDBGrid1.Columns.Count - 1
        If TDBGrid1.Columns(i).width > 0 Then
            If TDBGrid1.Columns(i).Visible = True Then
                ...
                strSQL = "update G_BLSField set B_GridWidth='" & dWidth & "' where B_ObjectID='11S012' and B_FieldName='" & szFieldName & "'"
...
'            MsgBox "第" & i & "行不能单价为0或者为空", vbInformation, "提示"
'            Exit Sub
'        End If
    ...
    sql1 = sql1 & "'12B003','YARN02','" & Gm.SysID.SystemUser & "','" & FlatEdit2.Text & "'"
...
Private Sub savedetail()
    ...
    Do While Not rsdetail.EOF
        ...
        sql2 = "exec usp_OriginalorderinsertDetail '" & item & "','" & id & "','" & rsdetail!B_ItemIDB & "','" & rsdetail!B_suppliersid & "'"
        sql2 = sql2 & ",'" & rsdetail!B_colorid & "','" & rsdetail!B_specification & "','" & rsdetail!B_qty & "','" & rsdetail!B_price & "'"
        sql2 = sql2 & ",'" & rsdetail!B_sum & "','" & rsdetail!B_Cang & "','" & rsdetail!B_memo & "','" & rsdetail!B_processid & "','" & rsdetail!B_supplement & "','" & rsdetail!B_level & "','" & rsdetail!B_DeliveryNote & "','" & rsdetail!B_BoxQty & "'"
...
Private Sub savetoupdate1()
    ...
    Do While Not rsdetail.EOF
        ...
        If rs3.RecordCount > 0 Then
            sql2 = "exec usp_Originalorderinsertdetail_update '" & rsdetail!B_itemid & "','" & id & "','" & rsdetail!B_ItemIDB & "','" & rsdetail!B_suppliersid & "'"
            sql2 = sql2 & ",'" & rsdetail!B_colorid & "','" & rsdetail!B_specification & "','" & rsdetail!B_qty & "','" & rsdetail!B_price & "'"
            sql2 = sql2 & ",'" & rsdetail!B_sum & "','" & rsdetail!B_Cang & "','" & rsdetail!B_memo & "','" & rsdetail!B_processid & "','" & rsdetail!B_supplement & "','" & rsdetail!B_level & "','" & rsdetail!B_DeliveryNote & "','" & rsdetail!B_BoxQty & "'"
...
Private Sub MoveFirst()
    ...
    sql = sql & " where B_ObjectID='12B003' and  B_BillType='YARN02'"
...
Private Sub MovePrevious()
    ...
    End If
     sql = "select top 1 B_id,B_CodeID,B_Date,B_Freightnum,B_HandNum,B_CarNum,B_payment,B_Shipment,b.B_ClientName,B_HandMent,c.B_Name,B_cope,B_drivename "
    sql = sql & " from G_BillYarn a left outer join G_ContactCompany b on a.B_Shipment=b.B_ClientID left outer join G_Employee c on a.B_HandMent=c.B_SID"
    sql = sql & " where B_ObjectID='12B003' and  B_BillType='YARN02' and B_ID<'" & id & "'"
...
Public Sub openbill()
   Dim sql As String
   Dim rs As New RecordSet
   sql = "select B_itemid,B_id,B_OrderCode,B_Supplier,b.B_ClientName,B_GoodsID,c.B_Name,a.B_Specification,B_Qty,a.B_Price,B_Sum,B_LotNumber,B_MemoDetail,B_Producer,d.B_ClientName as Client,B_supplement,B_level,B_DeliveryNote,B_boxqty"
