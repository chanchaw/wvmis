...
Begin VB.Form frmWhite_composition 
   ...
   EndProperty
   Icon            =   "frmWhite_composition.frx":0000
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   8025
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   14155
      _DataPath       =   ""
      Bands           =   "frmWhite_composition.frx":038A
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmWhite_composition.frx":0552
         AccessibleName  =   ""
         ...
         Begin VB.Frame Frame2 
            ...
            Begin XtremeSuiteControls.PushButton PushButton9 
               ...
               ImageGap        =   15
               IconWidth       =   16
               Icon            =   "frmWhite_composition.frx":05D8
            End
            Begin XtremeSuiteControls.PushButton PushButton10 
               ...
               ImageGap        =   15
               IconWidth       =   16
               Icon            =   "frmWhite_composition.frx":0AB8
            End
            Begin XtremeSuiteControls.PushButton PushButton14 
               ...
               ImageGap        =   15
               IconWidth       =   16
               Icon            =   "frmWhite_composition.frx":0F98
            End
         ...
         Begin VB.Frame Frame1 
            ...
            Begin XtremeSuiteControls.PushButton PushButton5 
               ...
               ImageGap        =   15
               IconWidth       =   16
               Icon            =   "frmWhite_composition.frx":1478
            End
            Begin XtremeSuiteControls.PushButton PushButton4 
               ...
               ImageGap        =   15
               IconWidth       =   16
               Icon            =   "frmWhite_composition.frx":1958
            End
            ...
            Begin XtremeSuiteControls.PushButton PushButton13 
               ...
               ImageGap        =   15
               IconWidth       =   16
               Icon            =   "frmWhite_composition.frx":1E38
            End
   ...
   End
End
Attribute VB_Name = "frmWhite_composition"
...
Private Sub PushButton14_Click()
           If yanzhenWhiteComposition(id) = False Then
             Exit Sub
        End If
       If ComboBox2.Text = "采购" Then
       ...
       If ComboBox2.Text = "采购" Then
        ...
        End If
         If Trim(FlatEdit13.Text) = "" Then
            ...
            Exit Sub
        End If
        If Trim(FlatEdit12.Text) = "" Or FlatEdit12.Text <= 0 Then
            MsgBox "数量不能为空或要大于0", vbInformation, "提示"
            Exit Sub
        End If
        If ComboBox2.Text = "调拨" Then
