...
Begin VB.Form frmWhitelastyearReport 
   Caption         =   "白坯上年度报表"
   ClientHeight    =   7215
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   12012
      _DataPath       =   ""
      Bands           =   "frmWhitelastyearReport.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmWhitelastyearReport.frx":0E50
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmWhitelastyearReport"
...
Private Sub grid()
    ...
    sql = "exec usp_whiteLastYearReport '" & a & "','" & b & "'"
...
Private Sub setgrid()
    ...
    TDBGrid1.Columns("B_client").Caption = "供应商"
    ...
    TDBGrid1.Columns("B_cang").Caption = "仓位"
    TDBGrid1.Columns("B_MemoDetail").Caption = "备注"
    TDBGrid1.Columns("B_YarnSpecification").Caption = "原料规格"
    TDBGrid1.HoldFields
