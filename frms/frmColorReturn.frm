...
Begin VB.Form frmColorReturn 
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmColorReturn.frx":5258
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmColorReturn"
...
FlatEdit1 = ""
    ...
    TDBGrid1.Columns("B_Weight").FooterText = "" & b & ""
End Sub
...
Private Sub setRs()
    ...
    rsdetail.Fields.Append "B_ProcessCost", adVarChar, 100
    ...
    For i = 0 To TDBGrid1.Columns.Count - 1
        If TDBGrid1.Columns(i).width > 0 Then
            If TDBGrid1.Columns(i).Visible = True Then
                ...
                strSQL = "update G_BLSField set B_GridWidth='" & dWidth & "' where B_ObjectID='11S033' and B_FieldName='" & szFieldName & "'"
...
'            MsgBox "第" & i & "行深加工不能为空", vbInformation, "提示"
'            Exit Sub
'        End If
    ...
    sql1 = sql1 & "'12B008','COL06 ','" & Gm.SysID.SystemUser & "','" & FlatEdit2.Text & "'"
...
Private Sub savedetail()
    ...
    Do While Not rsdetail.EOF
        ...
        sql2 = "exec usp_Colororderreturn '" & item & "','" & id & "','" & rsdetail!B_ItemIDB & "','" & rsdetail!B_departid & "'"
        ...
        sql2 = sql2 & ",'" & rsdetail!B_Clientid & "','" & rsdetail!B_DeliveryNote & "','" & rsdetail!B_type & "','" & rsdetail!B_Waitfreight & "','" & rsdetail!B_memo & "','" & rsdetail!B_processcost & "','" & rsdetail!B_processid & "','" & rsdetail!B_Freight & "','" & rsdetail!B_Prepaidfreight & "','" & rsdetail!B_color & "','" & rsdetail!B_orderitemid & "','" & rsdetail!B_DepartColor & "'"
        Debug.Print sql2
...
Private Sub TDBGrid1_BeforeColUpdate(ByVal colIndex As Integer, OldValue As Variant, Cancel As Integer)
    ...
    End If
    If colIndex = TDBGrid1.Columns("B_ProcessCost").colIndex Then
        TDBGrid1.Columns("B_ProcessCost").Value = Abs(Val(TDBGrid1.Columns("B_ProcessCost").Value))
    End If
...
Private Sub savetoupdate1()
    ...
    Do While Not rsdetail.EOF
        ...
        If rs3.RecordCount > 0 Then
            sql2 = "exec usp_ColorOrderturn_Update '" & rsdetail!B_ItemID & "','" & id & "','" & rsdetail!B_ItemIDB & "','" & rsdetail!B_departid & "'"
             sql2 = sql2 & ",'" & rsdetail!B_colorname & "','" & rsdetail!B_specification & "','" & rsdetail!B_colorid & "','" & rsdetail!B_SeHao & "'"
             sql2 = sql2 & ",'" & rsdetail!B_PIShu & "','" & rsdetail!B_weight & "','" & rsdetail!B_meter & "','" & rsdetail!B_Ma & "'"
             sql2 = sql2 & ",'" & rsdetail!B_Clientid & "','" & rsdetail!B_DeliveryNote & "','" & rsdetail!B_type & "','" & rsdetail!B_Waitfreight & "','" & rsdetail!B_memo & "','" & rsdetail!B_processcost & "','" & rsdetail!B_processid & "','" & rsdetail!B_Freight & "','" & rsdetail!B_Prepaidfreight & "','" & rsdetail!B_color & "','" & rsdetail!B_DepartColor & "'"
             Gm.cnnTool.cnn.Execute sql2
        Else
            saveadddetail
        End If
...
Private Sub MoveFirst()
    ...
    sql = sql & " left outer join G_Employee c on a.B_Hand=c.B_SID where B_ObjectID='12B008' and  B_BillType='COL06'"
...
Private Sub MovePrevious()
    ...
    sql = sql & " from G_Billcolor a left outer join G_ContactCompany b on a.B_Shipment=b.B_ClientID"
    sql = sql & " left outer join G_Employee c on a.B_Hand=c.B_SID where B_ObjectID='12B008' and  B_BillType='COL06' and B_ID<'" & id & "'"
...
Public Sub openbill()
   Dim sql As String
   Dim rs As New RecordSet
'   sql = "select c.B_HEX,c.B_name,B_sid, B_ItemID,B_ItemIDB,B_GoodsNameAlias,B_SeHao,B_Producer,B_width,B_weight,B_ps,B_KG,a.B_PactCode,a.B_Clientid,b.B_ClientName,B_waitfright,B_MemoDetail"
   ...
   Do While Not rs.EOF
        rsdetail.AddNew
           rsdetail!B_hex = rs!B_hex
            ...
            rsdetail!B_processcost = IIf(IsNull(rs!B_returnprocesscost), "", rs!B_returnprocesscost)
