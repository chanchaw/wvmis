...
Begin VB.Form frmPopupSew 
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmPopupSew.frx":0D64
         AccessibleName  =   ""
...
Private Sub GetClient()
    ...
    strSQL = "SELECT B_ChildID,B_parent FROM  G_CraftTree"
    Debug.Print strSQL
...
Private Sub SelectClientID()
    If rsClient.RecordCount <= 0 Then
        Exit Sub
    End If
    theClientID = rsClient!B_ChildID
    theClientName = rsClient!B_parent
...
Private Sub setstyle()
     ...
     TDBGrid1.Columns("B_ChildID").Caption = "工序名称"
     TDBGrid1.Columns("B_parent").Caption = "工序类别"
