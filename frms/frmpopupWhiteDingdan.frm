...
Begin VB.Form frmpopupWhiteDingdan 
   ...
   EndProperty
   Icon            =   "frmpopupWhiteDingdan.frx":0000
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   5355
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   9446
      _DataPath       =   ""
      Bands           =   "frmpopupWhiteDingdan.frx":038A
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmpopupWhiteDingdan.frx":0BE4
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmpopupWhiteDingdan"
...
Private Sub GetClient()
    ...
    strSQL = "select distinct B_OrderCode from G_Billdetailorder where B_id='" & id & "'"
...
Private Sub SelectClientID()
  If rsClient.RecordCount > 0 Then
    thedepartmentID = IIf(IsNull(rsClient!B_OrderCode), "", rsClient!B_OrderCode)
    rsClient.Close
