...
Begin VB.Form frmWhiteProcureInset 
   Caption         =   "白坯采购入库"
   ClientHeight    =   7455
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   13150
      _DataPath       =   ""
      Bands           =   "frmWhiteProcureInset.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmWhiteProcureInset.frx":51E4
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmWhiteProcureInset"
    ...
    For i = 0 To TDBGrid1.Columns.Count - 1
        If TDBGrid1.Columns(i).width > 0 Then
            If TDBGrid1.Columns(i).Visible = True Then
                ...
                strSQL = "update G_BLSField set B_GridWidth='" & dWidth & "' where B_ObjectID='11S050' and B_FieldName='" & szFieldName & "'"
...
'        End If
    ...
    sql1 = sql1 & "'12B006','WHT03 ','" & Gm.SysID.SystemUser & "','" & FlatEdit2.Text & "'"
...
Private Sub savedetail()
    ...
    Do While Not rsdetail.EOF
        ...
        sql2 = "exec usp_whiteprocuredetail '" & item & "','" & id & "','" & rsdetail!B_ItemIDB & "','" & rsdetail!B_supplierid & "'"
        sql2 = sql2 & ",'" & rsdetail!B_whiteid & "','" & rsdetail!B_Width & "','" & rsdetail!B_weight & "','" & rsdetail!B_PIShu & "'"
        sql2 = sql2 & ",'" & rsdetail!B_kg & "','" & rsdetail!B_Cang & "','" & rsdetail!B_processid & "','" & rsdetail!B_memo & "','" & rsdetail!B_supplement & "','" & rsdetail!B_price & "','" & rsdetail!B_sum & "','" & rsdetail!B_qty & "','" & rsdetail!B_DeliveryNote & "','" & rsdetail!B_Waitfreight & "','" & rsdetail!B_Freight & "','" & rsdetail!B_Prepaidfreight & "','" & rsdetail!B_Clientid & "','" & rsdetail!B_KxOutDingDanHao & "'"
        Debug.Print sql2
...
Private Sub savetoupdate1()
    ...
    Do While Not rsdetail.EOF
        ...
        If rs3.RecordCount > 0 Then
            sql2 = "exec usp_whiteprocuredetail_update '" & rsdetail!B_itemid & "','" & id & "','" & rsdetail!B_ItemIDB & "','" & rsdetail!B_supplierid & "'"
            sql2 = sql2 & ",'" & rsdetail!B_whiteid & "','" & rsdetail!B_Width & "','" & rsdetail!B_weight & "','" & rsdetail!B_PIShu & "'"
            sql2 = sql2 & ",'" & rsdetail!B_kg & "','" & rsdetail!B_Cang & "','" & rsdetail!B_processid & "','" & rsdetail!B_memo & "','" & rsdetail!B_supplement & "','" & rsdetail!B_price & "','" & rsdetail!B_sum & "','" & rsdetail!B_qty & "','" & rsdetail!B_DeliveryNote & "','" & rsdetail!B_Waitfreight & "','" & rsdetail!B_Freight & "','" & rsdetail!B_Prepaidfreight & "','" & rsdetail!B_Clientid & "','" & rsdetail!B_KxOutDingDanHao & "'"
...
'        End If
    ...
    End If
        ...
        Dim sql3 As String
        sql3 = "exec usp_whiteprocureprint '" & id & "','" & Gm.SysID.SystemUserName & "'"
        rs3.Open sql3, Gm.cnnTool.cnn, adOpenKeyset, adLockPessimistic
        
        Dim frm1 As New frmModBLRPreviewOri
        Set frm1.RecordSet = rs3.Clone
            
        frm1.ObjectID = "22B067"
        frm1.Show
...
Private Sub MoveFirst()
    ...
    sql = sql & " left outer join G_Employee c on a.B_Hand=c.B_SID where B_ObjectID='12B006' and  B_BillType='WHT03'"
...
Private Sub MovePrevious()
    ...
    sql = sql & " from G_BillWhite a left outer join G_ContactCompany b on a.B_Shipment=b.B_ClientID"
    sql = sql & " left outer join G_Employee c on a.B_Hand=c.B_SID where B_ObjectID='12B006' and  B_BillType='WHT03' and B_ID<'" & id & "'"
...
Public Sub openbill()
   Dim sql As String
   Dim rs As New RecordSet
   sql = "select B_ItemID,B_ItemIDB,B_Producer,b.B_ClientName as B_client,B_GoodsID,c.B_Name,B_Width,B_UnitWeight,B_pishu,B_kg,B_cang,B_Supplier,d.B_ClientName,B_MemoDetail,B_supplement,a.B_Price,B_sum,B_Waitfreight,B_freight,B_Prepaidfreight,e.B_ClientName as B_clientkh,a.B_Clientid,B_qty,B_DeliveryNote,a.B_KxOutDingDanHao"
