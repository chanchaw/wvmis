...
Begin VB.Form frmpopupEmploy 
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmpopupEmploy.frx":085A
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmpopupEmploy"
...
Private Sub GetClient()
    ...
    strSQL = "Select B_SID as B_ClientID,B_Name as  B_ClientName From G_Employee Where B_department='" & ContactType & "'"
...
Private Sub setstyle()
     ...
     TDBGrid1.Columns("B_ClientID").Caption = "员工编号"
     TDBGrid1.Columns("B_ClientName").Caption = "员工名称"
