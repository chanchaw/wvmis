...
Begin VB.Form frmYarnSumRepoart_ALL 
   Caption         =   "供应商对账单"
   ClientHeight    =   7455
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   13150
      _DataPath       =   ""
      Bands           =   "frmYarnSumRepoart_ALL.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmYarnSumRepoart_ALL.frx":18F8
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmYarnSumRepoart_ALL"
...
Private prcessid As String '染厂的id
...
Private Sub PushButton1_Click()
    ...
    frm3.Show vbModal
    Originalsuppliers = frm3.Compositionid
    FlatEdit3.Text = frm3.CompositionName
    Unload frm3
...
Private Sub grid()
    ...
    sql = "exec usp_YarnSumAll '" & a & "','" & b & "','" & prcessid & "','" & Originalsuppliers & "'"
    Debug.Print sql
...
'    setGridShow
    ...
    TDBGrid1.Columns("B_Name").Caption = "原料品名"

    TDBGrid1.Columns("sum1").Caption = "公斤"
    TDBGrid1.Columns("sum2").Caption = "匹数"
