...
Begin VB.Form frmOriginalLastYear_Edit 
   Caption         =   "上年度查询"
   ClientHeight    =   6600
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   11456
      _DataPath       =   ""
      Bands           =   "frmOriginalLastYear_Edit.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmOriginalLastYear_Edit.frx":085A
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmOriginalLastYear_Edit"
...
Private Sub grid()
    ...
    sql = "exec usp_selectOriginallastyear "
