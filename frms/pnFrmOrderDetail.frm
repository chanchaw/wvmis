...
Begin VB.Form pnFrmOrderDetail 
   BorderStyle     =   0  'None
   Caption         =   "Form1"
   ClientHeight    =   4875
   ClientLeft      =   0
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   8599
      _DataPath       =   ""
      Bands           =   "pnFrmOrderDetail.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"pnFrmOrderDetail.frx":01C8
         AccessibleName  =   ""
         AccessibleDescription=   ""
         AccessibleValue =   ""
         AccessibleRole  =   9
         Begin TrueOleDBGrid80.TDBGrid TDBGrid1 
            Bindings        =   "pnFrmOrderDetail.frx":0248
            Height          =   3855
            Left            =   30
            TabIndex        =   2
            Top             =   30
   ...
   End
End
Attribute VB_Name = "pnFrmOrderDetail"
...
Private Const dtsSQL As String = "dbo.usp_Rpt_GetOrders_olDetail"
