...
Begin VB.Form frmColorProcessReport 
   Caption         =   "深加工序时表"
   ClientHeight    =   7500
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   13229
      _DataPath       =   ""
      Bands           =   "frmColorProcessReport.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmColorProcessReport.frx":38A4
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmColorProcessReport"
...
Private Sub cob1()
    ComboBox1.Clear
    ComboBox1.AddItem "深加工入库"
    ComboBox1.AddItem "外发深加工"
    ComboBox1.AddItem "深加工未加工退回"
    ComboBox1.AddItem "色布退深加工"
    ComboBox1.AddItem "深加工回修布入库"
    ComboBox1.AddItem "全部"
    ComboBox1.Text = "全部"
End Sub
Private Sub cob2()
    ComboBox2.Clear
    ComboBox2.AddItem "白坯"
    ComboBox2.AddItem "色布"
...
Private Sub chose()
    If ComboBox1.Text = "全部" Then
        ch = 2
    End If
    If ComboBox1.Text = "深加工入库" Then
        ch = "COL10"
    End If
    If ComboBox1.Text = "外发深加工" Then
        ch = "COL15"
    End If
    If ComboBox1.Text = "深加工未加工退回" Then
        ch = "COL22"
    End If
       If ComboBox1.Text = "色布退深加工" Then
        ch = "COL16"
    End If
       If ComboBox1.Text = "深加工回修布入库" Then
        ch = "COL17"
    End If
    ...
    If ComboBox2.Text = "全部" Then
        whitecolor = ""
    End If
    If ComboBox2.Text = "白坯" Then
        whitecolor = "白坯"
    End If
    If ComboBox2.Text = "色布" Then
        whitecolor = "色布"
    End If
End Sub
...
Private Sub Grid()
    ...
    sql = "exec usp_colorprocessReport '" & a & "','" & b & "','" & Originalsuppliers & "','" & ch & "','" & Gm.SysID.SystemUserName & "','" & whitecolor & "','" & m_DateFormat & "'"
    Debug.Print sql
    ...
    For i = 0 To TDBGrid1.Columns.Count - 1
        If TDBGrid1.Columns(i).width > 0 Then
            If TDBGrid1.Columns(i).Visible = True Then
                ...
                strSQL = "update G_BLSField set B_GridWidth='" & dWidth & "' where B_ObjectID='11S056' and B_FieldName='" & szFieldName & "'"
...
Private Sub sumall1()
    ...
    For i = 1 To n
        ...
        Sum3 = Sum3 + Val(TDBGrid1.Columns("B_meter").Text)
        TDBGrid1.movenext
    Next i
    TDBGrid1.Columns("B_ps").FooterText = "" & Sum & ""
    TDBGrid1.Columns("B_kg").FooterText = "" & Sum2 & ""
    TDBGrid1.Columns("B_meter").FooterText = "" & Sum3 & ""
End Sub
...
Private Sub TDBGrid1_DblClick()
    ...
    If Trim(rs!B_BillType) = "COL10" Then '深加工入库
        openbill rss!B_id
    End If
    If Trim(rs!B_BillType) = "COL15" Then '外发深加工
        openbill1 rss!B_id
    End If
    
    If Trim(rs!B_BillType) = "COL22" Then '深加工未加工退回
        openbill2 rss!B_id
    End If
       If Trim(rs!B_BillType) = "COL16" Then '深加工未加工退回
        openbill3 rss!B_id
    End If
       If Trim(rs!B_BillType) = "COL17" Then '深加工未加工退回
        openbill4 rss!B_id
    End If
...
'        Exit Sub
'    End If
    Dim frm1 As New frmColorprocess
...
'        Exit Sub
'    End If
    Dim frm1 As New frmColorOutDelivery
...
'        Exit Sub
'    End If
    Dim frm1 As New frmColorprocessReturn_NO
...
'        Exit Sub
'    End If
    Dim frm1 As New frmColorprocessReturn
...
End Sub
'打开页面显示上面内容,,,,,色布入库
Private Sub openbill4(ByVal id As String)
    Dim a As Long
    a = TDBGrid1.bookmark
     Dim rs As New RecordSet
    Dim sql As String
...
'        Exit Sub
'    End If
    Dim frm1 As New frmColorProcessRepair
...
Private Sub processreturn()
    ...
    End If
End Sub
Private Sub ColorprocessReturn()
    ...
    End If
End Sub
Private Sub ColorProcessRepair()
