...
Begin VB.Form frmColorlastyearReport 
   Caption         =   "色布上年度报表"
   ClientHeight    =   7455
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   12012
      _DataPath       =   ""
      Bands           =   "frmColorlastyearReport.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmColorlastyearReport.frx":0E50
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmColorlastyearReport"
...
Private Sub Grid()
    ...
    sql = "exec usp_LastYearReport '" & a & "','" & b & "'"
...
Private Sub SetGrid()
    ...
    TDBGrid1.Columns("B_client").Caption = "客户"
...
Private Sub sumall()
    ...
    rs.MoveFirst
    Do While Not rs.EOF
        a = a + IIf(IsNull(Val(rs!B_ps)), 0, Val(rs!B_ps))
