...
Begin VB.Form frmWhitetransfers_Edit 
   Caption         =   "白坯调拨查询"
   ClientHeight    =   7305
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   11351
      _DataPath       =   ""
      Bands           =   "frmWhitetransfers_Edit.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmWhitetransfers_Edit.frx":12A2
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmWhitetransfers_Edit"
...
Private Sub grid()
    ...
    sql = "exec usp_selectwhitetransfers '" & FlatEdit1.Text & "','1'"
