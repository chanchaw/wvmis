...
Begin VB.Form frmWhitePositionReport 
   Caption         =   "白坯转库单序时表"
   ClientHeight    =   7665
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   13044
      _DataPath       =   ""
      Bands           =   "frmWhitePositionReport.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmWhitePositionReport.frx":23C8
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmWhitePositionReport"
...
Private Sub Grid()
    ...
    sql = "exec usp_whitePositionreport '" & a & "','" & b & "','" & FlatEdit1.Text & "','" & Originalsuppliers & "','" & Gm.SysID.SystemUserName & "','" & FlatEdit2.Text & "','" & m_DateFormat & "'"
    ...
    For i = 0 To TDBGrid1.Columns.Count - 1
        If TDBGrid1.Columns(i).width > 0 Then
            If TDBGrid1.Columns(i).Visible = True Then
                ...
                strSQL = "update G_BLSField set B_GridWidth='" & dWidth & "' where B_ObjectID='11S076' and B_FieldName='" & szFieldName & "'"
...
Private Sub TDBGrid1_DblClick()
    ...
    If Trim(rs!B_BillType) = "WHT12" Then
       
        openbill rss!B_id
    End If
'    If rs!B_BillType = "WHT03" Then
'        openbill1 rss!B_id
'    End If
'    If rs!B_BillType = "WHT05" Then
'        openbill1 rss!B_id
'    End If
...
'        Exit Sub
'    End If
    Dim frm1 As New frmWhitePosition
    frm1.id = rs!B_id
