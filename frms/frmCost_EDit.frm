...
Begin VB.Form frmCost_EDit 
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmCost_EDit.frx":1E34
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmCost_EDit"
...
Private Sub grid()
    ...
    sql = "exec usp_CostDetail '" & b & "','" & a & "'"
    rss.Open sql, Gm.cnnTool.cnn, adOpenKeyset, adLockPessimistic
    TDBGrid1.DataSource = rss
    setgrid
End Sub
Private Sub setgrid()
    TDBGrid1.Columns("B_date").Caption = "制单时间"
    TDBGrid1.Columns("B_Name").Caption = "品名"
