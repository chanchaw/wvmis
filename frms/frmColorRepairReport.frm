...
Begin VB.Form frmColorRepairReport 
   Caption         =   "色布回修序时表"
   ClientHeight    =   7365
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   13044
      _DataPath       =   ""
      Bands           =   "frmColorRepairReport.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmColorRepairReport.frx":23D0
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmColorRepairReport"
...
Private Sub grid()
    ...
    sql = "exec usp_colorRepairReport '" & a & "','" & b & "','" & Originalsuppliers & "','" & ch & "','" & Gm.SysID.SystemUserName & "'"
    Debug.Print sql
    ...
    For i = 0 To TDBGrid1.Columns.Count - 1
        If TDBGrid1.Columns(i).width > 0 Then
            If TDBGrid1.Columns(i).Visible = True Then
                ...
                strSQL = "update G_BLSField set B_GridWidth='" & dWidth & "' where B_ObjectID='11S045' and B_FieldName='" & szFieldName & "'"
