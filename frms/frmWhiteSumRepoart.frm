...
Begin VB.Form frmWhiteSumRepoart 
   Caption         =   "染厂收发存汇总"
   ClientHeight    =   7515
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   13044
      _DataPath       =   ""
      Bands           =   "frmWhiteSumRepoart.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmWhiteSumRepoart.frx":18F8
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmWhiteSumRepoart"
...
Private Sub Grid()
    ...
    sql = "exec usp_WhiteSum '" & a & "','" & b & "','" & FlatEdit1.Text & "','" & Originalsuppliers & "','" & Gm.SysID.SystemUserName & "','" & FlatEdit3.Text & "'"
    Debug.Print sql
...
Private Sub sumall()
   ...
   TDBGrid1.Columns("sum1").FooterText = "" & j & ""
    ...
    TDBGrid1.Columns("sum6").FooterText = "" & i & ""
End Sub
