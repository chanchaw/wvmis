...
Begin VB.Form frmWhitePrint 
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmWhitePrint.frx":162C
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmWhitePrint"
...
Private Sub Grid()
    ...
    sql = "exec usp_PrintWhitePlan '" & Trim(FlatEdit1.Text) & "'"
...
Private Sub TDBGrid1_DblClick()
    Dim frm1 As New frmWhitePrint_Edit
    frm1.Show vbModal
    
    Unload frm1
End Sub

'打印白坯流转卡(打印一次的，需要改变打印次数吗)
Private Sub printwhite()
'    If TDBGrid1.RecordCount <= 0 Then
'        Exit Sub
'    End If
'    Dim rs As New RecordSet
'    Dim sql As String
'    sql = "exec usp_printWhite '" & rss!B_ID & "','" & rss!B_itemid & "'"
'
