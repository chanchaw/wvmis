...
Begin VB.Form frmOriginaldeliveryReport 
   Caption         =   "原料发货序时表"
   ClientHeight    =   7500
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   13044
      _DataPath       =   ""
      Bands           =   "frmOriginaldeliveryReport.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmOriginaldeliveryReport.frx":1EC6
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmOriginaldeliveryReport"
...
Private Sub Grid()
    ...
    sql = "exec usp_OriginalprocessReport '" & a & "','" & b & "','" & Originalsuppliers & "','" & m_DateFormat & "'"
...
Private Sub sumall()
    ...
    TDBGrid1.Columns("B_boxqty").FooterText = "" & d & ""
End Sub
Private Sub sumall1()
    Dim Sum As Double
    Dim Sum2 As Double
    ...
    For i = 1 To n
        ...
        Sum2 = Sum2 + Val(TDBGrid1.Columns("B_boxqty").Text)
        TDBGrid1.movenext
    Next i
    TDBGrid1.Columns("sum2").FooterText = "" & Sum & ""
    TDBGrid1.Columns("B_boxqty").FooterText = "" & Sum2 & ""
End Sub
