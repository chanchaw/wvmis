...
Begin VB.Form frmpopupAccessories 
   Caption         =   "辅料"
   ClientHeight    =   5940
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   10478
      _DataPath       =   ""
      Bands           =   "frmpopupAccessories.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmpopupAccessories.frx":085A
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmpopupAccessories"
...
Private Sub GetClient()
    ...
    strSQL = "Select B_SID,B_Name,B_Parent From G_Accessories"
...
Private Sub SelectClientID()
    ...
    thedepartID = rsClient!B_sid
    thedepartName = rsClient!B_name
...
Private Sub setstyle()
     ...
     TDBGrid1.Columns("B_SID").Caption = "辅料编号"
     TDBGrid1.Columns("B_Name").Caption = "辅料名称"
    TDBGrid1.Columns("B_Parent").Caption = "辅料类别"
