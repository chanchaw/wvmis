...
Begin VB.Form frmProductProcureDelivery 
   Caption         =   "成品采购发货"
   ClientHeight    =   7155
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   12621
      _DataPath       =   ""
      Bands           =   "frmProductProcureDelivery.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmProductProcureDelivery.frx":53FA
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmProductProcureDelivery"
    ...
    For i = 0 To TDBGrid1.Columns.Count - 1
        If TDBGrid1.Columns(i).width > 0 Then
            If TDBGrid1.Columns(i).Visible = True Then
                ...
                strSQL = "update G_BLSField set B_GridWidth='" & dWidth & "' where B_ObjectID='11S071' and B_FieldName='" & szFieldName & "'"
...
'    sql = "select * from G_BilldetailProduct where B_itemid='" & itemid & "'"
...
Private Sub save()
    ...
    sql1 = sql1 & "'12B016','PRO04 ','" & Gm.SysID.SystemUser & "','" & FlatEdit2.Text & "'"
...
Private Sub MoveFirst()
    ...
    sql = sql & " left outer join G_Employee c on a.B_Hand=c.B_SID where B_ObjectID='12B016' and  B_BillType='PRO04'"
...
Private Sub MovePrevious()
    ...
    sql = sql & " from G_BillProduct a left outer join G_ContactCompany b on a.B_Shipment=b.B_ClientID"
    sql = sql & " left outer join G_Employee c on a.B_Hand=c.B_SID where B_ObjectID='12B016' and  B_BillType='PRO04' and B_ID<'" & id & "'"
