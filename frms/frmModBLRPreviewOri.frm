...
Begin VB.Form frmModBLRPreviewOri 
   Caption         =   "打印预览"
   ClientHeight    =   6960
   ClientLeft      =   120
   ClientTop       =   450
   ...
   EndProperty
   Icon            =   "frmModBLRPreviewOri.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   6960
   ScaleWidth      =   11415
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   12277
      _DataPath       =   ""
      Bands           =   "frmModBLRPreviewOri.frx":038A
      ...
      Begin DDActiveReportsViewer2Ctl.ARViewer2 ARViewer21 
         ...
         _ExtentX        =   18441
         _ExtentY        =   9869
         SectionData     =   "frmModBLRPreviewOri.frx":1BBE
      End
   ...
   End
End
Attribute VB_Name = "frmModBLRPreviewOri"
...
Public m_Judeg As Long  '用来判断无格式导出时凯鑫运费使用的方法
...
'    Dim xlSheet As excel.Worksheet
    ...
    If m_Judeg = 1 Then
        ...
        Do While Not A_rs.EOF
            rs.MoveFirst
            Do While Not rs.EOF
                xlSheet.Cells(j + 1, f + 1).Value = cls1.KillCrlfSpace(A_rs(Trim(rs!B_FieldName)))
                        m = "B" & j
                       n = "B" & j + 1
                If A_rs!B_id = m_ID1 And f + 1 = 2 Then
                     'xlSheet.Range("'" & m & "':'" & n & "'").Merge
                     xlSheet.Range(m & ":" & n).Merge
                End If
                rs.movenext
                f = f + 1
