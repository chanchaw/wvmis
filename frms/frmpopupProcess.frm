...
Begin VB.Form frmpopupProcess 
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   9446
      _DataPath       =   ""
      Bands           =   "frmpopupProcess.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmpopupProcess.frx":085A
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmpopupProcess"
...
Private theprocessID As String
Private theprocessName As String
...
Private Sub GetClient()
    ...
    strSQL = "Select B_ClientID,B_ClientName From G_ContactCompany Where B_ContactType='深加工'"
...
Private Sub SelectClientID()
    ...
    theprocessID = rsClient!B_Clientid
    theprocessName = rsClient!B_ClientName
