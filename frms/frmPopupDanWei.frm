...
Begin VB.Form frmPopupDanWei 
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmPopupDanWei.frx":085A
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmPopupDanWei"
...
Private Sub GetClient()
    ...
    strSQL = "Select B_ClientID,B_ClientName From G_ContactCompany Where B_ContactType='" & ContactType & "'"
