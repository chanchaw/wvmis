...
Begin VB.Form frmWhiteProcessreport 
   Caption         =   "外加工白坯入库明细"
   ClientHeight    =   7125
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   13229
      _DataPath       =   ""
      Bands           =   "frmWhiteProcessreport.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmWhiteProcessreport.frx":1836
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmWhiteProcessreport"
...
Private Sub grid()
    ...
    sql = "exec usp_whiteprocessreport '" & a & "','" & b & "','" & Originalsuppliers & "','" & ComboBox1.Text & "','" & FlatEdit3.Text & "'"
    Debug.Print sql
...
Private Sub setgrid()
    setGridShow
'    TDBGrid1.Columns("B_DateCreate").Caption = "入库时间"
'    TDBGrid1.Columns("B_CodeID").Caption = "入库单据"
'    TDBGrid1.Columns("B_PS").Caption = "匹数"
'    TDBGrid1.Columns("B_KG").Caption = "公斤"
'
'    TDBGrid1.Columns("B_Shipment").Caption = "运方"
'    TDBGrid1.Columns("B_PNumber").Caption = "车牌号"
'    TDBGrid1.Columns("B_payment").Caption = "结算方式"
'    TDBGrid1.Columns("B_Freight").Caption = "运费"
'     TDBGrid1.Columns("B_hand").Caption = "装卸方"
    ...
    For i = 0 To TDBGrid1.Columns.Count - 1
        If TDBGrid1.Columns(i).width > 0 Then
            If TDBGrid1.Columns(i).Visible = True Then
                ...
                strSQL = "update G_BLSField set B_GridWidth='" & dWidth & "' where B_ObjectID='11S015' and B_FieldName='" & szFieldName & "'"
...
Private Sub TDBGrid1_DblClick()
    ...
    sql = "exec usp_WhiteProcessselect '" & rss!B_id & "'"
    rs.Open sql, Gm.cnnTool.cnn, adOpenKeyset, adLockPessimistic
    sql1 = "exec usp_WhiteProcessselect_Edit '" & rss!B_id & "'"
    rs1.Open sql1, Gm.cnnTool.cnn, adOpenKeyset, adLockPessimistic
    
    
    Dim frm1 As New frmWhiteProcessInset
    frm1.id = rs!B_id
    frm1.FlatEdit3 = rs!B_Codeid
    frm1.DTPicker1.Value = rs!B_Date
    frm1.FlatEdit2.Text = rs!B_Freight
    frm1.FlatEdit6.Text = rs!B_PlateNumber
    frm1.FlatEdit4.Text = rs!B_PNumber
    frm1.ComboBox1.Text = rs!B_payment
    frm1.Originalsuppliers = rs!B_Shipment
    frm1.FlatEdit1.Text = IIf(IsNull(rs!B_ClientName), "", rs!B_ClientName)
    frm1.fh = rs!B_Hand
    frm1.FlatEdit5.Text = IIf(IsNull(rs!B_name), "", rs!B_name)
'    Set frm1.rsDetail = rs.Clone
    Do While Not rs1.EOF
        frm1.rsdetail.addnew
        frm1.rsdetail!B_itemid = rs1!B_itemid
        frm1.rsdetail!B_ItemIDB = rs1!B_ItemIDB
        frm1.rsdetail!B_supplier = rs1!B_ClientName
        frm1.rsdetail!B_supplierid = rs1!B_Producer
        frm1.rsdetail!B_whiteName = rs1!B_name
        frm1.rsdetail!B_whiteid = rs1!B_GoodsID
        frm1.rsdetail!B_Width = rs1!B_Width
        frm1.rsdetail!B_weight = rs1!B_UnitWeight
        frm1.rsdetail!B_PIShu = rs1!B_PIShu
        frm1.rsdetail!B_kg = rs1!B_kg
        frm1.rsdetail!B_Cang = rs1!B_Cang
        frm1.rsdetail!B_process = rs1!B_Client
        frm1.rsdetail!B_processid = rs1!B_supplier
        frm1.rsdetail!B_memo = rs1!B_MemoDetail
        frm1.rsdetail!B_supplement = IIf(IsNull(rs1!B_supplement), 0, rs1!B_supplement)
        frm1.rsdetail.Update
        rs1.movenext
    Loop
...
Private Sub TDBGrid1_RowColChange(LastRow As Variant, ByVal LastCol As Integer)
    ...
    sql1 = "exec usp_whiteprocessreport_Edit '" & a & "'"
...
'    TDBGrid2.Columns("B_pishu").Caption = "匹数"
'    TDBGrid2.Columns("B_kg").Caption = "公斤"
'    TDBGrid2.Columns("B_cang").Caption = "仓位"
'    TDBGrid2.Columns("B_Supplier").Caption = "外发加工"
'
...
Private Sub setGridShow1()
    Dim cls2 As New clsGridShow
    With cls2
        .ObjectID = "11S016"
    ...
    For i = 0 To TDBGrid2.Columns.Count - 1
        If TDBGrid2.Columns(i).width > 0 Then
            If TDBGrid2.Columns(i).Visible = True Then
                ...
                strSQL = "update G_BLSField set B_GridWidth='" & dWidth & "' where B_ObjectID='11S016' and B_FieldName='" & szFieldName & "'"
                Gm.cnnTool.cnn.Execute strSQL
            End If
        End If
    Next
...
Private Sub sumall()
    ...
    Do While Not rss.EOF
        a = a + IIf(IsNull(rss!B_ps), 0, rss!B_ps)
        b = b + IIf(IsNull(rss!B_kg), 0, rss!B_kg)
        rss.movenext
    Loop
    rss.MoveFirst
    c = Format(b, "0.0")
    TDBGrid1.Columns("B_DateCreate").FooterText = "合计"
...
Private Sub sumall1()
    ...
    Do While Not rss1.EOF
        a = a + IIf(IsNull(rss1!B_PIShu), 0, rss1!B_PIShu)
        b = b + IIf(IsNull(rss1!B_kg), 0, rss1!B_kg)
        rss1.movenext
    Loop
    rss1.MoveFirst
    c = Format(b, "0.0")
    ...
    TDBGrid2.Columns("B_kg").FooterText = "" & c & ""
End Sub
