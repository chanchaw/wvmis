...
Begin VB.Form frmOriginalcontract_Edit 
   Caption         =   "原料订单"
   ClientHeight    =   4035
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   7117
      _DataPath       =   ""
      Bands           =   "frmOriginalcontract_Edit.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmOriginalcontract_Edit.frx":0F3C
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmOriginalcontract_Edit"
...
Private Sub PushButton1_Click()
    ...
    frm1.Show vbModal
    FlatEdit1.Text = frm1.CompositionName
...
Private Sub save()
    ...
    If Trim(FlatEdit1.Text) = "" Then
        MsgBox "原料名称不能空", vbInformation, "提示"
        Exit Sub
    End If
    If Trim(FlatEdit2.Text) = "" Then
        MsgBox "规格不能空", vbInformation, "提示"
        Exit Sub
    End If
...
Private Sub Update_Edit()
     If validation = True Then
        ...
        sql = "update G_BilldetailYarn set B_GoodsID='" & OriginalProduct & "',B_Specification='" & FlatEdit2.Text & "',B_Qty='" & FlatEdit3.Text & "'"
...
Private Sub saveALL_Edit()
    If validation = True Then
        ...
        rs.Update
        itemid = rs!B_itemid
        sql1 = "exec usp_InsertOriginalOrder '" & itemid & "','" & id & "','" & OriginalProduct & "','" & FlatEdit2.Text & "'"
        sql1 = sql1 & ",'" & FlatEdit3.Text & "','" & FlatEdit4.Text & "','" & FlatEdit5.Text & "','" & a & "','" & FlatEdit7.Text & "','" & "" & "','" & B_yuanOrderid & "'"
...
Private Sub Update()
    ...
    Dim a As String
    a = Format(DTPicker1.Value, "YYYY-MM-DD")
    sql = "update G_draftBilldetailYarn set B_GoodsID='" & OriginalProduct & "',B_Specification='" & FlatEdit2.Text & "',B_Qty='" & FlatEdit3.Text & "'"
    sql = sql & ",B_price='" & FlatEdit4.Text & "',B_sum='" & FlatEdit5.Text & "',B_DeliveryTime='" & a & "',B_MemoDetail='" & FlatEdit7.Text & "'"
    sql = sql & " where B_itemid='" & itemid & "'"
    Gm.cnnTool.cnn.Execute sql
End Sub
