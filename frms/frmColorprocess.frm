...
Begin VB.Form frmColorprocess 
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   13996
      _DataPath       =   ""
      Bands           =   "frmColorprocess.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmColorprocess.frx":5258
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmColorprocess"
...
Private Sub setRs()
    ...
    rsdetail.Fields.Append "B_whitecolor", adVarChar, 100
...
'    TDBGrid1.Columns("B_Memo").Caption = ""
   ...
   TDBGrid1.Columns("B_whitecolor").ValueItems.Presentation = dbgComboBox
    ...
    For i = 0 To TDBGrid1.Columns.Count - 1
        If TDBGrid1.Columns(i).width > 0 Then
            If TDBGrid1.Columns(i).Visible = True Then
                ...
                strSQL = "update G_BLSField set B_GridWidth='" & dWidth & "' where B_ObjectID='11S025' and B_FieldName='" & szFieldName & "'"
...
Private Sub save()
    ...
    sql1 = sql1 & "'12B008','COL10 ','" & Gm.SysID.SystemUser & "','" & FlatEdit2.Text & "'"
...
Private Sub savedetail()
    ...
    Do While Not rsdetail.EOF
        ...
        sql2 = sql2 & ",'" & rsdetail!B_Clientid & "','" & rsdetail!B_DeliveryNote & "','" & rsdetail!B_type & "','" & rsdetail!B_Waitfreight & "','" & rsdetail!B_processid & "','" & rsdetail!B_memo & "','" & "" & "','" & "" & "','" & "" & "','" & "" & "','" & rsdetail!B_whitecolor & "','" & rsdetail!B_Freight & "','" & rsdetail!B_Prepaidfreight & "','" & rsdetail!B_color & "','" & rsdetail!B_orderitemid & "','" & rsdetail!B_DepartColor & "','" & rsdetail!B_Cang & "','','" & rsdetail!B_DanJia & "',''"
...
Private Sub saveandprint()
    ...
    Do While Not rsdetail.EOF
        ...
        End If
        If rsdetail!B_process = "" Then
            MsgBox "第" & i & "行深加工单位2不能为空", vbInformation, "提示"
            Exit Sub
        End If
...
Private Sub sumall()
    ...
    rs.MoveFirst
    Do While Not rs.EOF
        a = a + IIf(IsNull(rs!B_weight), 0, rs!B_weight)
    ...
    TDBGrid1.Columns("B_Ma").FooterText = "" & j & ""
End Sub
'打印中保存修改
Private Sub savetoupdate1()
   ...
   If ComboBox3.Text = "是" Then
    ...
    If ComboBox3.Text = "" Then
        d = ""
    End If
    sql1 = "exec usp_Colororder_Update  '" & id & "','" & FlatEdit3.Text & "','" & a & "','CLC',"
    sql1 = sql1 & "'12B008','COL10 ','" & Gm.SysID.SystemUser & "','" & FlatEdit2.Text & "'"
    sql1 = sql1 & ",'" & FlatEdit6.Text & "','" & FlatEdit4.Text & "','" & ComboBox1.Text & "','" & Originalsuppliers & "','" & fh & "','" & ComboBox2.Text & "','" & FlatEdit7.Text & "','" & d & "','" & FlatEdit8.Text & "'"
    Gm.cnnTool.cnn.Execute sql1
    rsdetail.MoveFirst
    Do While Not rsdetail.EOF
        ...
        If rs3.RecordCount > 0 Then
            ...
            sql2 = sql2 & ",'" & rsdetail!B_colorname & "','" & rsdetail!B_specification & "','" & rsdetail!B_colorid & "','" & rsdetail!B_SeHao & "'"
            sql2 = sql2 & ",'" & rsdetail!B_PIShu & "','" & rsdetail!B_weight & "','" & rsdetail!B_meter & "','" & rsdetail!B_Ma & "'"
            sql2 = sql2 & ",'" & rsdetail!B_Clientid & "','" & rsdetail!B_DeliveryNote & "','" & rsdetail!B_type & "','" & rsdetail!B_processid & "','" & rsdetail!B_memo & "','" & "" & "','" & "" & "','" & "" & "','" & "" & "','" & rsdetail!B_whitecolor & "','" & rsdetail!B_Waitfreight & "','" & rsdetail!B_Freight & "','" & rsdetail!B_Prepaidfreight & "','" & rsdetail!B_color & "','" & rsdetail!B_DepartColor & "','" & rsdetail!B_Cang & "','','" & rsdetail!B_DanJia & "',''"
            Gm.cnnTool.cnn.Execute sql2
        Else
            saveadddetail
        End If
...
Private Sub TDBGrid1_ButtonClick(ByVal ColIndex As Integer)
    ...
    If TDBGrid1.Columns("B_depart").ColIndex = ColIndex Then
     Dim frm1 As New frmPopupDanWei
    frm1.ContactType = "深加工"
    frm1.Show vbModal
    rsdetail!B_departid = frm1.clientid
    rsdetail!B_depart = frm1.ClientName
    Unload frm1
    End If
    
'    If TDBGrid1.Columns("B_whitecolor").ColIndex = ColIndex Then
'     'Dim frm1 As New frmPopupDanWei
'    frm1.ContactType = "深加工"
'    frm1.Show vbModal
'    rsdetail!B_departid = frm1.Clientid
...
Private Sub MoveFirst()
    ...
    sql = sql & " left outer join G_Employee c on a.B_Hand=c.B_SID where B_ObjectID='12B008' and  B_BillType='COL10'"
...
Private Sub MovePrevious()
    ...
    sql = sql & " from G_Billcolor a left outer join G_ContactCompany b on a.B_Shipment=b.B_ClientID"
    sql = sql & " left outer join G_Employee c on a.B_Hand=c.B_SID where B_ObjectID='12B008' and  B_BillType='COL10' and B_ID<'" & id & "'"
...
Public Sub openbill()
   ...
   sql = "exec usp_colorprocessopenbill '" & id & "'"
   rs.Open sql, Gm.cnnTool.cnn, adOpenKeyset, adLockPessimistic
   ...
   Do While Not rs.EOF
        rsdetail.AddNew
           ...
           End If
            ...
            rsdetail!B_depart = IIf(IsNull(rs!B_departid), "", rs!B_departid)
            rsdetail!B_colorname = rs!B_GoodsNameAlias
