...
Begin VB.Form frmSelectWhite 
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmSelectWhite.frx":12AA
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmSelectWhite"
...
Private Sub Form_Load()
    ...
    DTPicker2.Value = Format(Now - 1, "YYYY-MM-DD")
    grid
End Sub
Private Sub InitFrm()
    With ActiveBar21
...
Private Sub grid()
    ...
    sql = "exec usp_SelectWhiteReprot '" & a & "','" & b & "','" & Trim(FlatEdit2.Text) & "','" & Gm.SysID.SystemUserName & "'"
    Debug.Print sql
...
Private Sub setgrid()
    ...
    TDBGrid1.Columns("B_DateCreate").Caption = "制单日期"
    TDBGrid1.Columns("datetime").Caption = "交期"
    ...
    TDBGrid1.Columns("B_BoxQty").Caption = "数量"
    TDBGrid1.Columns("B_BCIncr").Caption = "卡号"
    
    TDBGrid1.Columns("B_user").Visible = False
    TDBGrid1.Columns("B_user").AllowSizing = False
    TDBGrid1.Columns("B_user").Locked = True
    TDBGrid1.Columns("B_Sdate").Visible = False
    TDBGrid1.Columns("B_Sdate").AllowSizing = False
    TDBGrid1.Columns("B_Sdate").Locked = True
        TDBGrid1.Columns("B_Edate").Visible = False
    TDBGrid1.Columns("B_Edate").AllowSizing = False
    TDBGrid1.Columns("B_Edate").Locked = True
        TDBGrid1.Columns("B_DingDan").Visible = False
    TDBGrid1.Columns("B_DingDan").AllowSizing = False
    TDBGrid1.Columns("B_DingDan").Locked = True
...
Private Sub sumall()
    ...
    TDBGrid1.Columns("B_BoxQty").FooterText = "" & b & ""
