...
Begin VB.Form frmOriginalProducerDetailReport 
   Caption         =   "加工户收发存明细"
   ClientHeight    =   7500
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   13229
      _DataPath       =   ""
      Bands           =   "frmOriginalProducerDetailReport.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmOriginalProducerDetailReport.frx":19F6
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmOriginalProducerDetailReport"
    ...
    For i = 0 To TDBGrid1.Columns.Count - 1
        If TDBGrid1.Columns(i).width > 0 Then
            If TDBGrid1.Columns(i).Visible = True Then
                ...
                strSQL = "update G_BLSField set B_GridWidth='" & dWidth & "' where B_ObjectID='11S046' and B_FieldName='" & szFieldName & "'"
...
Private Sub grid()
    ...
    sql = "exec usp_Originalproducerdetail '" & a & "','" & b & "','" & Originalsuppliers & "','" & Gm.SysID.SystemUserName & "','" & FlatEdit1.Text & "'"
