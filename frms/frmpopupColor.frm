...
Begin VB.Form frmpopupColor 
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmpopupColor.frx":0BE4
         AccessibleName  =   ""
         ...
         Begin MSComctlLib.ImageList ImageList2 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmpopupColor.frx":0C64
                  Key             =   ""
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmpopupColor.frx":11FE
                  Key             =   ""
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmpopupColor.frx":1798
                  Key             =   ""
               EndProperty
            EndProperty
         End
   ...
   End
End
Attribute VB_Name = "frmpopupColor"
...
Private Sub InitFrm()
    ...
    A_TreeTableName = "G_ColorCategory"
...
Private Sub GetClient()
    ...
    strSQL = "select B_SID,B_Name,B_Red,B_Green,B_Blue,B_Hex from G_Color where 1=1"
...
'    Dim lys As Long
    'Dim r As SGRow
'    For i = 0 To 2
'        Grd.Columns(i).BackColor = vbRed
'    Next
'    Do While Not rsClient.EOF
'        ys.Red = rsClient!B_Red
'        ys.Green = rsClient!B_Green
'        ys.Blue = rsClient!B_Blue
'        lys = RGBToLong(ys)
'
'        rsClient.MoveNext
'    Loop
...
Private Sub setstyle()
     ...
     TDBGrid1.Columns("B_SID").Caption = "颜色编号"
     ...
     TDBGrid1.Columns("B_Hex").Caption = "颜色"
     TDBGrid1.Columns("B_Hex").width = 1500
      TDBGrid1.HoldFields
End Sub
...
'Private Sub TDBGrid1_FetchCellStyle(ByVal Condition As Integer, ByVal Split As Integer, _
'    Bookmark As Variant, ByVal Col As Integer, ByVal CellStyle As TrueOleDBGrid80.StyleDisp)
'
'    Dim ys As RGB
'    Dim lys As Long
'    ys.Red = TDBGrid1.Columns("B_Red").Value
'    ys.Green = TDBGrid1.Columns("B_Green").Value
'    ys.Blue = TDBGrid1.Columns("B_Blue").Value
'    lys = RGBToLong(ys)
'    CellStyle.BackColor = lys
'End Sub
...
'    Debug.Print strSQL
    ...
    strSQL = "select * from G_Color where 1=1"
    szNode = Node.Text
    If szNode <> "全部分类" Then
...
'    Dim ys As RGB
'    With ys
'        .Red = TDBGrid1.Columns("B_Red").Value
'        .Green = TDBGrid1.Columns("B_Green").Value
'        .Blue = TDBGrid1.Columns("B_Blue").Value
'    End With
