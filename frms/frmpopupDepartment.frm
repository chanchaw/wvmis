...
Begin VB.Form frmpopupDepartment 
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   9128
      _DataPath       =   ""
      Bands           =   "frmpopupDepartment.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmpopupDepartment.frx":085A
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmpopupDepartment"
...
Private thedepartmentID As String
Private thedepartmentName As String
...
Private Sub GetClient()
    ...
    strSQL = "Select B_SID,B_Name,B_phone From G_Employee Where B_Department='染厂跟单'"
...
Private Sub SelectClientID()
  If rsClient.RecordCount > 0 Then
    thedepartmentID = rsClient!B_sid
    thedepartmentName = rsClient!B_name
    thephone = IIf(IsNull(rsClient!B_phone), "", rsClient!B_phone)
...
Private Sub setstyle()
     ...
     TDBGrid1.Columns("B_SID").Caption = "染厂跟单编号"
     TDBGrid1.Columns("B_Name").Caption = "染厂订单名称"
