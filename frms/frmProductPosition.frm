...
Begin VB.Form frmProductPosition 
   Caption         =   "成品转库单"
   ClientHeight    =   7845
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   13838
      _DataPath       =   ""
      Bands           =   "frmProductPosition.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmProductPosition.frx":53FA
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmProductPosition"
...
Private Const theObjectID As String = "12B016"  '订单单据对象编号
    ...
    For i = 0 To TDBGrid1.Columns.Count - 1
        If TDBGrid1.Columns(i).width > 0 Then
            If TDBGrid1.Columns(i).Visible = True Then
                ...
                strSQL = "update G_BLSField set B_GridWidth='" & dWidth & "' where B_ObjectID='11S079' and B_FieldName='" & szFieldName & "'"
...
Private Sub TDBGridAddOneRow(ByVal vItemID As Long)
    Dim sql As String
    Dim rs As New RecordSet
    sql = "exec usp_ProductOrderChoose_procure '" & vItemID & "'"
    rs.Open sql, Gm.cnnTool.cnn, adOpenKeyset, adLockPessimistic
...
Private Sub save()
    ...
    Loop
    If id <> "" Then
         strSQL = "select * from G_BillProduct where B_ID='" & id & "'"
...
'    Dim D As String
    ...
    sql1 = sql1 & "'12B016','PRO05 ','" & Gm.SysID.SystemUser & "','" & FlatEdit2.Text & "'"
...
'        End If
        sql2 = "exec usp_InsertProductPosition '" & item & "','" & id & "','" & rsdetail!B_ItemIDB & "','" & rsdetail!B_departid & "'"
        ...
        sql2 = sql2 & ",'" & rsdetail!B_Clientid & "','" & rsdetail!B_DeliveryNote & "','" & rsdetail!B_type & "','" & rsdetail!B_Waitfreight & "','" & rsdetail!B_processid & "','" & rsdetail!B_memo & "','" & "" & "','" & rsdetail!B_repaircost & "','" & "" & "','" & "" & "','','" & rsdetail!B_Freight & "','" & rsdetail!B_Prepaidfreight & "','" & rsdetail!B_color & "','" & rsdetail!B_orderitemid & "','" & rsdetail!B_DepartColor & "','" & rsdetail!B_Cang & "','" & rsdetail!B_beforeCang & "'"
...
Private Sub saveandprint()
    ...
    End If
        ...
        Dim sql3 As String
        sql3 = "exec usp_ProductOrderreport '" & id & "','" & Gm.SysID.SystemUserName & "'"
...
Private Sub savetoupdate1()
    ...
    If ComboBox3.Text = "" Then
        b = ""
    End If
    sql1 = "exec usp_Productorder_Update  '" & id & "','" & FlatEdit3.Text & "','" & a & "','WHT',"
    sql1 = sql1 & "'12B016','PRO05 ','" & Gm.SysID.SystemUser & "','" & FlatEdit2.Text & "'"
...
'        End If
        ...
        If rs3.RecordCount > 0 Then
            sql2 = "exec usp_ProductPosition_Update '" & rsdetail!B_itemid & "','" & id & "','" & rsdetail!B_ItemIDB & "','" & rsdetail!B_departid & "'"
            sql2 = sql2 & ",'" & rsdetail!B_colorname & "','" & rsdetail!B_specification & "','" & rsdetail!B_colorid & "','" & rsdetail!B_SeHao & "'"
            sql2 = sql2 & ",'" & rsdetail!B_PIShu & "','" & rsdetail!B_weight & "','" & rsdetail!B_meter & "','" & rsdetail!B_Ma & "'"
            sql2 = sql2 & ",'" & rsdetail!B_Clientid & "','" & rsdetail!B_DeliveryNote & "','" & rsdetail!B_type & "','" & rsdetail!B_processid & "','" & rsdetail!B_memo & "','" & "" & "','" & rsdetail!B_repaircost & "','" & "" & "','" & "" & "','','" & rsdetail!B_Waitfreight & "','" & rsdetail!B_Freight & "','" & rsdetail!B_Prepaidfreight & "','" & rsdetail!B_color & "','" & rsdetail!B_DepartColor & "','" & rsdetail!B_Cang & "','" & rsdetail!B_beforeCang & "'"
            Gm.cnnTool.cnn.Execute sql2
        Else
            saveadddetail
        End If
...
Private Sub MoveFirst()
    ...
    sql = sql & " left outer join G_Employee c on a.B_Hand=c.B_SID where B_ObjectID='12B016' and  B_BillType='PRO05'"
...
Private Sub MovePrevious()
    ...
    sql = sql & " from G_BillProduct a left outer join G_ContactCompany b on a.B_Shipment=b.B_ClientID"
    sql = sql & " left outer join G_Employee c on a.B_Hand=c.B_SID where B_ObjectID='12B016' and  B_BillType='PRO05' and B_ID<'" & id & "'"
...
Public Sub openbill()
   ...
   sql = "exec usp_Productorderopenbill '" & id & "'"
   rs.Open sql, Gm.cnnTool.cnn, adOpenKeyset, adLockPessimistic
