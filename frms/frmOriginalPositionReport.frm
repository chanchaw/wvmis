...
Begin VB.Form frmOriginalPositionReport 
   Caption         =   "转库单序时表"
   ClientHeight    =   7080
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   12488
      _DataPath       =   ""
      Bands           =   "frmOriginalPositionReport.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmOriginalPositionReport.frx":23C8
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmOriginalPositionReport"
...
'        Exit Sub
'    End If
    Dim frm1 As New frmOriginalPosition
    frm1.id = rs!B_id
...
Private Sub Grid()
    ...
    sql = "exec usp_OriginalPositionReport '" & a & "','" & b & "','" & Originalsuppliers & "','" & ch & "','" & Gm.SysID.SystemUserName & "','" & m_DateFormat & "'"
    Debug.Print sql
    ...
    For i = 0 To TDBGrid1.Columns.Count - 1
        If TDBGrid1.Columns(i).width > 0 Then
            If TDBGrid1.Columns(i).Visible = True Then
                ...
                strSQL = "update G_BLSField set B_GridWidth='" & dWidth & "' where B_ObjectID='11S074' and B_FieldName='" & szFieldName & "'"
