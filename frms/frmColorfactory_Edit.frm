...
Begin VB.Form frmColorfactory_Edit 
   Caption         =   "合同订单查询"
   ClientHeight    =   6735
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   11880
      _DataPath       =   ""
      Bands           =   "frmColorfactory_Edit.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmColorfactory_Edit.frx":12A2
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmColorfactory_Edit"
...
Public Sub Grid()
    ...
    sql = "exec usp_orderOrder  '" & Trim(FlatEdit1.Text) & "'"
    Debug.Print sql
...
Private Sub SetGrid()
    ...
    TDBGrid1.Columns("B_ClientName").Caption = "合同客户"
...
'    TDBGrid1.Columns("khname").Caption = "客户名"
    ...
    TDBGrid1.Columns("B_PatternCode").Caption = "色号"
    
    TDBGrid1.Columns("B_OrderCode").width = 1000
