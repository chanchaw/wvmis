...
Begin VB.Form frmOriginalorderselect 
   Caption         =   "原料对比"
   ClientHeight    =   6945
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   12012
      _DataPath       =   ""
      Bands           =   "frmOriginalorderselect.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmOriginalorderselect.frx":1320
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmOriginalorderselect"
...
Private Sub grid()
    ...
    Dim sql As String
    sql = "exec usp_Originalorderselect '" & FlatEdit1.Text & "'"
...
'    TDBGrid1.Columns("B_qty1").Caption = "订单采购数量"
'    TDBGrid1.Columns("B_price1").Caption = "参考单价"
'    TDBGrid1.Columns("B_Qty").Caption = "到货数量"
'    TDBGrid1.Columns("B_Price").Caption = "到货单价"
'    TDBGrid1.Columns("B_Sum").Caption = "金额"
'    TDBGrid1.Columns("B_DateLast").Caption = "最后到货时间"
    TDBGrid1.HoldFields
    ...
    For i = 0 To TDBGrid1.Columns.Count - 1
        If TDBGrid1.Columns(i).width > 0 Then
            If TDBGrid1.Columns(i).Visible = True Then
                ...
                strSQL = "update G_BLSField set B_GridWidth='" & dWidth & "' where B_ObjectID='11S028' and B_FieldName='" & szFieldName & "'"
