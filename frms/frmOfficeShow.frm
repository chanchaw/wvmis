...
Begin VB.Form frmOfficeShow 
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmOfficeShow.frx":08D0
         AccessibleName  =   ""
         ...
         Begin TrueOleDBGrid80.TDBGrid TDBGrid1 
            ...
            Splits(0)._ColumnProps(6)=   "Column(1).Width=3307"
   ...
   End
End
Attribute VB_Name = "frmOfficeShow"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private rsDye As New RecordSet
Private strSQL As String

Private theDyeID As String
Private theDyeName As String

Public theID As String

Public Property Get DyeID() As String
    DyeID = theDyeID
End Property

Public Property Get DyeName() As String
    DyeName = theDyeName
End Property
...
Private Sub GetDye()
        ...
        strSQL = "SELECT B_ItemCategory FROM G_OfficeCategory"
       rsDye.Open strSQL, Gm.cnnTool.cnn, adOpenKeyset, adLockPessimistic
    
    TDBGrid1.DataSource = rsDye
End Sub

Private Sub SelectDyeID()
    If TDBGrid1.ApproxCount <= 0 Then
        Exit Sub
    End If
    
    theDyeName = rsDye!B_ItemCategory
...
Private Sub setstyle()
     TDBGrid1.Columns("B_ItemCategory").Caption = "项目类型"
     TDBGrid1.Columns("B_ItemCategory").width = 3000

'     TDBGrid1.Columns("Operator").Caption = "制作人"
...
Private Sub TDBGrid1_FilterChange()
    Dim oldCol As Long
    oldCol = TDBGrid1.Col
    ExeTDBGridFilterChange TDBGrid1, rsDye
    TDBGrid1.Col = oldCol
    
    TDBGrid1.SetFocus
    TDBGrid1.SelStart = Len(TDBGrid1.Columns(oldCol).Text)
...
Private Sub ExeTDBGridFilterChange(ByRef vTDBGrid As TDBGrid, ByRef vRs As RecordSet)
    ...
    'TDBGrid1.HoldFields
    vRs.Filter = GetFilterString(vTDBGrid)
End Sub


Private Function GetFilterString(ByRef vTDBGrid As TDBGrid) As String
    ...
    For Each Col In cols
        If Len(Col.FilterText) > 0 Then
            ...
            Select Case Col.DataWidth
                Case 6, 11, 23
                    szTemp = szTemp & " " & Col.DataField & "=" & Col.FilterText
                Case Else
                    szTemp = szTemp & " " & Col.DataField & " like '%" & Col.FilterText & "%'"
            End Select
        End If
    ...
    GetFilterString = szTemp
    
    
    Debug.Print GetFilterString
End Function
