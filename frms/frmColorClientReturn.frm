...
Begin VB.Form frmColorClientReturn 
   Caption         =   "客户退货"
   ClientHeight    =   7950
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   14023
      _DataPath       =   ""
      Bands           =   "frmColorClientReturn.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmColorClientReturn.frx":5258
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmColorClientReturn"
...
'   TDBGrid1.Columns("B_SeHao").Locked = True
   ...
   TDBGrid1.Columns("B_DeliveryGoods").Caption = "退货单位"
   TDBGrid1.Columns("B_Deliveryaddress").Caption = "退货原因"
...
Private Sub save()
    ...
    sql1 = sql1 & "'12B008','COL11 ','" & Gm.SysID.SystemUser & "','" & FlatEdit2.Text & "'"
...
Private Sub savedetail()
    ...
    Do While Not rsdetail.EOF
        ...
        sql2 = "exec usp_insertColorDelivery '" & item & "','" & id & "','" & rsdetail!B_ItemIDB & "'"
        sql2 = sql2 & ",'" & rsdetail!B_name & "','" & rsdetail!B_SeHao & "','" & rsdetail!B_Hua & "','" & rsdetail!B_Width & "','" & rsdetail!B_weight & "','" & rsdetail!B_PIShu & "'"
        sql2 = sql2 & ",'" & rsdetail!B_kg & "','" & rsdetail!B_PactCode & "','" & rsdetail!B_Clientid & "','" & rsdetail!B_Waitfreight & "','" & rsdetail!B_memo & "','" & rsdetail!B_colorid & "','" & rsdetail!B_colorname & "','" & rsdetail!B_Freight & "','" & rsdetail!B_Prepaidfreight & "','" & rsdetail!B_orderitemid & "','" & rsdetail!B_DepartColor & "','" & rsdetail!B_Deliveryaddress & "','" & rsdetail!B_DeliveryGoods & "','" & rsdetail!B_meter & "'"
...
Private Sub MoveFirst()
    ...
    sql = sql & " left outer join G_Employee c on a.B_Hand=c.B_SID where B_ObjectID='12B008' and  B_BillType='COL11'"
...
Private Sub MovePrevious()
    ...
    sql = sql & " from G_Billcolor a left outer join G_ContactCompany b on a.B_Shipment=b.B_ClientID"
    sql = sql & " left outer join G_Employee c on a.B_Hand=c.B_SID where B_ObjectID='12B008' and  B_BillType='COL11' and B_ID<'" & id & "'"
...
Public Sub openbill()
   ...
   sql = sql & " B_sid,a.B_meter, B_ItemID,B_ItemIDB,B_GoodsNameAlias,B_SeHao,B_Producer,B_width,B_weight,B_ps,B_KG,a.B_PactCode,a.B_Clientid,b.B_ClientName,B_Waitfreight,B_MemoDetail,B_freight,B_Prepaidfreight,B_departColor,B_Deliveryaddress,B_DeliveryGoods"
...
Private Sub saveupdate1()
    ...
    If ComboBox3.Text = "" Then
        d = ""
    End If
    sql1 = "exec usp_ColorDeliveryupdate  '" & id & "','" & FlatEdit3.Text & "','" & a & "','CLC',"
    sql1 = sql1 & "'12B008','COL11 ','" & Gm.SysID.SystemUser & "','" & FlatEdit2.Text & "'"
    sql1 = sql1 & ",'" & FlatEdit6.Text & "','" & FlatEdit4.Text & "','" & ComboBox1.Text & "','" & Originalsuppliers & "','" & fh & "','" & ComboBox2.Text & "','" & FlatEdit7.Text & "','" & d & "','" & FlatEdit8.Text & "'"
    Gm.cnnTool.cnn.Execute sql1
    savedetailupdate
