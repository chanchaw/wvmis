...
Begin VB.Form frmOriginalinventory 
   Caption         =   "原料库存表"
   ClientHeight    =   7485
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   13044
      _DataPath       =   ""
      Bands           =   "frmOriginalinventory.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmOriginalinventory.frx":18F8
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmOriginalinventory"
...
'下拉匡绑定
Private Sub cob1()
'    ComboBox1.AddItem "分订单号"
'    ComboBox1.AddItem "不分订单号"
'    ComboBox1.Text = "不分订单号"
End Sub
...
'    frm1.ContactType = "白坯加工商"
    frm1.Show vbModal
    Originalsuppliers = frm1.Compositionid
    FlatEdit3.Text = frm1.CompositionName
    Unload frm1
End Sub
...
'    b = Format(DTPicker2.Value, "YYYY-MM-DD")
    sql = "exec usp_OriginaldeliveryReport '" & FlatEdit1.Text & "','" & Originalsuppliers & "','" & 1 & "','" & Gm.SysID.SystemUserName & "'"
     Debug.Print sql
...
Private Sub grid1()
    ...
    sql = "exec usp_OriginaldeliveryReport '" & FlatEdit1.Text & "','" & Originalsuppliers & "','" & 2 & "','" & Gm.SysID.SystemUserName & "'"
...
TDBGrid1.Columns("sum2").NumberFormat = "0.0"
    ...
    TDBGrid1.Columns("B_Specification").Caption = "规格型号"
...
TDBGrid2.Columns("sum2").NumberFormat = "0.0"
    ...
    TDBGrid2.Columns("B_Name").Caption = "原料品名"
    TDBGrid2.Columns("B_Specification").Caption = "规格型号"
...
Private Sub Printstyle()
        ...
        sql = "exec usp_OriginaldeliveryReport '" & FlatEdit1.Text & "','" & Originalsuppliers & "','" & c & "','" & Gm.SysID.SystemUserName & "'"
...
Private Sub sumall1()
    ...
    rs.MoveFirst
        ...
        Loop
        c = Format(a, "0.0")
        TDBGrid2.Columns("sum2").FooterText = "" & c & ""
    End If
End Sub
