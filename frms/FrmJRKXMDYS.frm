...
Begin VB.Form FrmJRKXMDYS 
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"FrmJRKXMDYS.frx":13D4
         AccessibleName  =   ""
...
Private Sub Grid()
    ...
    sql = "SELECT B_GroupName,B_ObjectID from G_JRKXMDYS WHERE B_Order>993 AND B_Order<1000"
...
End Sub
Private Sub setgrid()
    TDBGrid1.Columns("B_GroupName").Caption = "细码单样式"
    TDBGrid1.Columns("B_ObjectID").Caption = "细码单编号"
    
   TDBGrid1.Columns("B_GroupName").width = 7000
'    TDBGrid1.Columns("sum1").width = 1000
    TDBGrid1.Columns("B_ObjectID").Visible = False
    TDBGrid1.Columns("B_ObjectID").Locked = True
    TDBGrid1.Columns("B_ObjectID").AllowSizing = False
...
Private Sub choose()
    If TDBGrid1.ApproxCount <= 0 Then
        Exit Sub
    End If
   m_GroupName = rss!B_GroupName
   m_ObjectID = rss!B_ObjectID
    bsaved = 1
    Me.Hide
End Sub
