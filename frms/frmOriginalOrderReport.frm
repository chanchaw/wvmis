...
Begin VB.Form frmOriginalOrderReport 
   Caption         =   "原料入库明细表"
   ClientHeight    =   7185
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin ActiveBar2LibraryCtl.ActiveBar2 ActiveBar21 
      ...
      _ExtentY        =   13229
      _DataPath       =   ""
      Bands           =   "frmOriginalOrderReport.frx":0000
      Begin C1SizerLibCtl.C1Elastic C1Elastic1 
         ...
         FloodStyle      =   1
         _GridInfo       =   $"frmOriginalOrderReport.frx":1836
         AccessibleName  =   ""
   ...
   End
End
Attribute VB_Name = "frmOriginalOrderreport"
...
Private Sub Grid()
    ...
    sql = "exec usp_OriginalOrderReport '" & a & "','" & b & "','" & Originalsuppliers & "','" & ComboBox1.Text & "','" & FlatEdit3.Text & "'"
    Debug.Print sql
    ...
    For i = 0 To TDBGrid1.Columns.Count - 1
        If TDBGrid1.Columns(i).width > 0 Then
            If TDBGrid1.Columns(i).Visible = True Then
                ...
                strSQL = "update G_BLSField set B_GridWidth='" & dWidth & "' where B_ObjectID='11S020' and B_FieldName='" & szFieldName & "'"
...
Private Sub TDBGrid1_DblClick()
    ...
    sql = "exec usp_OriginalOrderdetailSelect '" & rss!B_id & "'"
    rs.Open sql, Gm.cnnTool.cnn, adOpenKeyset, adLockPessimistic
    sql1 = "exec usp_OriginalOrderdetailSelect_Edit '" & rss!B_id & "'"
    ...
    frm1.FlatEdit2.Text = rs!B_Freightnum
    frm1.FlatEdit6.Text = rs!B_HandNum
    frm1.FlatEdit4.Text = rs!B_CarNum
    frm1.ComboBox1.Text = rs!B_payment
    frm1.Originalsuppliers = IIf(IsNull(rs!B_Clientid), "", rs!B_Clientid)
    frm1.FlatEdit1.Text = IIf(IsNull(rs!B_Shipment), "", rs!B_Shipment)
    frm1.fh = IIf(IsNull(rs!B_sid), "", rs!B_sid)
    frm1.FlatEdit5.Text = IIf(IsNull(rs!B_Hand), "", rs!B_Hand)
'    Set frm1.rsDetail = rs.Clone
    Do While Not rs1.EOF
        frm1.rsdetail.AddNew
        frm1.rsdetail!B_ItemID = rs1!B_ItemID
        frm1.rsdetail!B_ItemIDB = rs1!B_ordercode
        frm1.rsdetail!B_suppliers = rs1!B_ClientName
        frm1.rsdetail!B_suppliersid = rs1!B_supplier
        frm1.rsdetail!B_colorname = IIf(IsNull(rs1!B_name), "", rs1!B_name)
        frm1.rsdetail!B_colorid = IIf(IsNull(rs1!B_GoodsID), "", rs1!B_GoodsID)
        frm1.rsdetail!B_specification = rs1!B_specification
        frm1.rsdetail!B_qty = rs1!B_qty
        frm1.rsdetail!B_price = rs1!B_price
        frm1.rsdetail!B_Sum = rs1!B_Sum
        frm1.rsdetail!B_Cang = rs1!B_LotNumber
        frm1.rsdetail!B_memo = rs1!B_MemoDetail
        frm1.rsdetail!B_processid = rs1!B_Producer
        frm1.rsdetail!B_process = IIf(IsNull(rs1!B_Client), "", rs1!B_Client)
...
Private Sub TDBGrid1_RowColChange(LastRow As Variant, ByVal LastCol As Integer)
    ...
    sql1 = "exec usp_OriginalOrderdetailReport '" & a & "'"
    ...
    For i = 0 To TDBGrid2.Columns.Count - 1
        If TDBGrid2.Columns(i).width > 0 Then
            If TDBGrid2.Columns(i).Visible = True Then
                ...
                strSQL = "update G_BLSField set B_GridWidth='" & dWidth & "' where B_ObjectID='11S021' and B_FieldName='" & szFieldName & "'"
                Gm.cnnTool.cnn.Execute strSQL
            End If
        End If
    Next
